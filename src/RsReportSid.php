...
class RsReportSid
{
    ...
    public const MAIL_CAMPAIGN_DETAIL = 37;

    /** Mail campaign history list report. */
    public const MAIL_CAMPAIGN_LIST = 36;

    /** Mail history list report. */
    public const MAIL_HISTORY_LIST = 38;

    /** Member progress body fat report in chart view. */
    public const MEMBER_PROGRESS_LOG_BODY_FAT = 149;

    /** Member progress report collection for charts. */
    public const MEMBER_PROGRESS_LOG_CHART = 146;

    /** Report with list of progress log per client. */
    public const MEMBER_PROGRESS_LOG_CLIENT = 150;

    /** Member progress main report in table view. */
    public const MEMBER_PROGRESS_LOG_LIST = 147;

    /** Member progress report collection for table. */
    public const MEMBER_PROGRESS_LOG_TABLE = 145;

    /** Member progress weight report in chart view. */
    public const MEMBER_PROGRESS_LOG_WEIGHT = 148;

    /** List of clients' credit cards with expiration date. */
    public const PAY_BANK_CARD_EXPIRE = 44;

    /** Total Sum Processed by all Businesses. */
    public const PAY_METHOD_BUSINESS = 235;

    /** Total Sum Processed from all Businesses to wellnessliving. */
    public const PAY_METHOD_SYSTEM = 78;

    /** Processing per Business with Login Date. */
    public const PAY_METHOD_SYSTEM_LOGIN = 242;

    /** A report to track history of refunds. */
    public const PAY_REFUND = 45;

    /** A list of payment transactions that are in the NMI batches. */
    public const PAY_TRANSACTION_BATCH = 77;

    /** List of Cash Outs. */
    public const PAY_TRANSACTION_CASH = 113;

    /** If the report is opened in backend it shows a list of transactions for the current business. */
    public const PAY_TRANSACTION_LIST = 34;

    /** If the report is opened in backend it shows a list of transactions for the current business. */
    public const PAY_TRANSACTION_SUM = 119;

    /** Revenue Report for WellnessLiving Accounting. */
    public const PAY_TRANSACTION_SYSTEM_ALL = 79;

    /** If the report is opened in backend it shows a list of system transactions for the current business. */
    public const PAY_TRANSACTION_SYSTEM_LIST = 62;

    /** Revenue Report for WellnessLiving Accounting. */
    public const PAY_TRANSACTION_SYSTEM_REFUND = 106;

    /** Sum of all transactions from businesses to system merchants. */
    public const PAY_TRANSACTION_SYSTEM_SUMMARY = 143;

    /** If the report is opened in backend it shows a list of transactions for the one given user in the current business. */
    public const PAY_TRANSACTION_USER = 120;

    /** This report is available for user in client app. */
    public const PAY_TRANSACTION_USER_CLIENT = 253;

    /** Postcard history list report. */
    public const POSTCARD_HISTORY = 103;

    /** Attendance history report in frontend. */
    public const PROFILE_ATTENDANCE_SCHEDULE_FRONTEND_HISTORY = 180;

    /** Upcoming schedule report in frontend. */
    public const PROFILE_ATTENDANCE_SCHEDULE_FRONTEND_UPCOMING = 179;

    /** Attendance history report. */
    public const PROFILE_ATTENDANCE_SCHEDULE_HISTORY = 178;

    /** Attendance history report for given login promotion. */
    public const PROFILE_ATTENDANCE_SCHEDULE_LOGIN_PROMOTION_HISTORY = 262;

    /** Upcoming schedule report for given login promotion. */
    public const PROFILE_ATTENDANCE_SCHEDULE_LOGIN_PROMOTION_UPCOMING = 263;

    /** Upcoming schedule report. */
    public const PROFILE_ATTENDANCE_SCHEDULE_UPCOMING = 177;

    /** Contract list report in client profile. */
    public const PROFILE_CONTRACT_LIST = 255;

    /** Report to view list of responses for specific user in client profile. */
    public const PROFILE_FORM_RESPONSE = 265;

    /** Gift Card report in client profile. */
    public const PROFILE_PURCHASE_REPORT_COUPON = 193;

    /** Session Pass report in client profile. */
    public const PROFILE_PURCHASE_REPORT_EVENT = 192;

    /** Groupon report in client profile. */
    public const PROFILE_PURCHASE_REPORT_GROUPON = 213;

    /** Membership report in client profile. */
    public const PROFILE_PURCHASE_REPORT_MEMBERSHIP = 188;

    /** Package report in client profile. */
    public const PROFILE_PURCHASE_REPORT_PACKAGE = 189;

    /** Duration Pass report in client profile. */
    public const PROFILE_PURCHASE_REPORT_SESSION_DURATION = 190;

    /** Session Pass report in client profile. */
    public const PROFILE_PURCHASE_REPORT_SESSION_PASS = 191;

    /** Single Session report in client profile. */
    public const PROFILE_PURCHASE_REPORT_SESSION_SINGLE = 194;

    /** Intro offers metric. */
    public const PROMOTION_INTRODUCTORY_METRIC_CHART = 206;

    /** Shows list of memberships with negative balances. */
    public const PROMOTION_MEMBERSHIP_NEGATIVE = 130;

    /** Shows list of pricing options from that were imported mindbody and converted into memberships. */
    public const PROMOTION_PASS_MEMBERSHIP = 108;

    /** A list of payment transactions including scheduled transaction (recurrent payments for memberships and renewals of */
    public const PURCHASE_AUTO_LIST = 60;

    /** Report with list of sales per client. */
    public const PURCHASE_CLIENT_SUMMARY = 115;

    /** Summary franchise memberships report (chart view). */
    public const PURCHASE_FRANCHISE_MEMBERSHIP_CHART = 175;

    /** Summary franchise memberships report. */
    public const PURCHASE_FRANCHISE_MEMBERSHIP_DETAIL = 257;

    /** Summary franchise memberships report. */
    public const PURCHASE_FRANCHISE_MEMBERSHIP_LIST = 174;

    /** Purchases that have been bought divided by payment methods. */
    public const PURCHASE_ITEM_ACCRUAL_CASH = 123;

    /** Purchases that have been bought divided by time. */
    public const PURCHASE_ITEM_ACCRUAL_CASH_CHART = 171;

    /** Special quick purchases report for migration. */
    public const PURCHASE_ITEM_ACCRUAL_MIGRATION = 132;

    /** Summaries of the sales divided by days, months or years. */
    public const PURCHASE_ITEM_ACCRUAL_SUMMARY = 133;

    /** Purchase item count. */
    public const PURCHASE_ITEM_COUNT = 27;

    /** Purchase item count product. */
    public const PURCHASE_ITEM_COUNT_PRODUCT = 50;

    /** Purchase item count revenue. */
    public const PURCHASE_ITEM_COUNT_REVENUE = 51;

    /** Purchase item list. */
    public const PURCHASE_ITEM_LIST = 26;

    /** All sales report. */
    public const PURCHASE_ITEM_LIST_PRODUCT = 48;

    /** Sales With Revenue Categories report. */
    public const PURCHASE_ITEM_LIST_REVENUE = 49;

    /** List of sale for the one user. */
    public const PURCHASE_ITEM_LIST_USER = 118;

    /** List of memberships in chart format. */
    public const PURCHASE_MEMBERSHIP_CHART = 165;

    /** List of memberships. */
    public const PURCHASE_MEMBERSHIP_LIST = 71;

    /** Lost members metric. */
    public const PURCHASE_MEMBERSHIP_METRIC_CHART = 198;

    /** Recurring revenue metric. */
    public const PURCHASE_MEMBERSHIP_RECURRING_METRIC_CHART = 202;

    /** All sales metric. */
    public const PURCHASE_METRIC_CHART = 195;

    /** All sales YOY metric. */
    public const PURCHASE_METRIC_YOY = 201;

    /** Report with list of sales grouped by purchase options. Products and drop-ins are not included. */
    public const PURCHASE_OPTION_SUMMARY = 109;

    /** Purchase tag count. */
    public const PURCHASE_TAG_COUNT = 30;

    /** Purchase tag list. */
    public const PURCHASE_TAG_LIST = 31;

    /** Report taxes of business in list format. */
    public const PURCHASE_TAX_COUNT = 29;

    /** Report taxes of business in chart format. */
    public const PURCHASE_TAX_LIST = 28;

    /** List of sales with non zero tips. */
    public const PURCHASE_TIP = 99;

    /** Tips summary by staff. */
    public const PURCHASE_TIP_SUM = 101;

    /** Report to view list of responses for specific quiz. */
    public const QUIZ_RESPONSE = 264;

    /** Report with list of generated reports. */
    public const REPORT_BACKGROUND_GENERATE = 246;

    /** Report with list of customers reviews. Available only in business backend and contains reviews on this business. */
    public const REVIEW_LIST = 47;

    /** Report with list of customers reviews. Available out of the backend and contains reviews on all businesses. */
    public const REVIEW_ROOT = 53;

    /** Report client's reward points. */
    public const REWARD_BOARD = 56;

    /** Schedule prospect count. */
    public const SCHEDULE_PROSPECT_COUNT = 9;

    /** Daily Tracker. */
    public const SCHEDULE_PROSPECT_LIST = 10;

    /** Report about daily booking activity special for dashboard. */
    public const SCHEDULE_PROSPECT_LIST_TODAY = 39;

    /** Schedule wait list. */
    public const SCHEDULE_WAIT_LIST = 11;

    /** Products, Purchase Options and Packages with Barcode. */
    public const SHOP_BARCODE = 102;

    /** Inventory On Hand. */
    public const SHOP_PRODUCT = 80;

    /** Physical Inventory Count. */
    public const SHOP_PRODUCT_OPTION_INVENTORY_COUNT = 243;

    /** SMS history report. */
    public const SMS_HISTORY = 116;

    /** Social sharing details. */
    public const SOCIAL_SHARE_DETAILS_LIST = 212;

    /** All social sharing. */
    public const SOCIAL_SHARE_METRIC_CHART = 197;
    ...
    public const VISIT_DUPLICATE = 131;

    /** Controls visit event report in chart format. */
    public const VISIT_EVENT_COUNT = 69;

    /** Event details analysis report */
    public const VISIT_EVENT_DETAIL = 68;

    /** Event analysis report */
    public const VISIT_EVENT_LIST = 67;

    /** Old first visits report. */
    public const VISIT_FIRST_COUNT = 3;

    /** Old first visits report. */
    public const VISIT_FIRST_LIST = 2;

    /** Filterable first visit list report, allowing to see first visits to certain criteria (locations/events/etc.) */
    public const VISIT_FIRST_SCOPED_COUNT = 224;

    /** Filterable first visit list report, allowing to see first visits to certain criteria (locations/events/etc.) */
    public const VISIT_FIRST_SCOPED_LIST = 223;

    /** Detail franchise cross-location visits table for franchisee. */
    public const VISIT_FRANCHISE_LOCATION_CROSS_DETAIL_FRANCHISEE = 186;

    /** Detail franchise cross-location visits table. */
    public const VISIT_FRANCHISE_LOCATION_CROSS_DETAIL_LIST = 157;

    /** Summary franchise cross-location visits chart. */
    public const VISIT_FRANCHISE_LOCATION_CROSS_SUMMARY_CHART = 164;

    /** Summary franchise cross-location visits table for franchisee. */
    public const VISIT_FRANCHISE_LOCATION_CROSS_SUMMARY_FRANCHISEE = 187;

    /** Summary franchise cross-location visits table. */
    public const VISIT_FRANCHISE_LOCATION_CROSS_SUMMARY_LIST = 158;

    /** Expired passes report in chart format. */
    public const VISIT_LAST_COUNT = 8;

    /** Expired passes report in list format. */
    public const VISIT_LAST_LIST = 7;

    /** Detail cross-location visits table. For regular businesses. */
    public const VISIT_LOCATION_CROSS_DETAIL_LIST = 168;

    /** Summary cross-location visits chart. For regular businesses. */
    public const VISIT_LOCATION_CROSS_SUMMARY_CHART = 170;

    /** Summary cross-location visits table. For regular businesses. */
    public const VISIT_LOCATION_CROSS_SUMMARY_LIST = 169;

    /** Visit login list. */
    public const VISIT_LOGIN_LIST = 12;

    /** Visits Remaining. */
    public const VISIT_REMAIN_LIST = 63;

    /** Visits Remaining. */
    public const VISIT_REMAIN_LIST_TEMP = 144;

    /** Detailed revenue by service. */
    public const VISIT_REVENUE_DETAIL = 58;

    /** Service revenue analysis. */
    public const VISIT_REVENUE_LIST = 57;

    /** Risky clients. */
    public const VISIT_RISK = 41;

    /** Event capacity utilization metric. */
    public const VISIT_RISK_ISAAC = 216;

    /** Visit staff average count. */
    public const VISIT_STAFF_AVERAGE_COUNT = 19;

    /** Visit staff average list. */
    public const VISIT_STAFF_AVERAGE_LIST = 17;

    /** Visit staff count. */
    public const VISIT_STAFF_COUNT = 15;

    /** Visit staff list. */
    public const VISIT_STAFF_LIST = 13;

    /** Detail list of unpaid visits. */
    public const VISIT_UNPAID_DETAIL = 74;

    /** List of unpaid visits. */
    public const VISIT_UNPAID_LIST = 73;

    /** Monthly coaching sessions YOY report for Curves business. */
    public const VISIT_WORKOUT_APPOINTMENT_LIST = 210;

    /** Monthly coaching sessions YOY report for Curves business. */
    public const VISIT_WORKOUT_APPOINTMENT_YOY = 211;

    /** Workout list report for Curves business. */
    public const VISIT_WORKOUT_GYM_LIST = 209;

    /** Workout YOY report for Curves business. */
    public const VISIT_WORKOUT_GYM_YOY = 207;

    /** Report with list of businesses connected to FitLIVE. */
    public const ZOOM_SYSTEM_BUSINESS = 258;

    /** Report with list of businesses connected to FitLIVE. */
    public const ZOOM_SYSTEM_COUNT = 259;
}
