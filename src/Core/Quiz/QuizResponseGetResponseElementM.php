...
class QuizResponseGetResponseElementM
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementMAmendment|null
     */
    public ?QuizResponseGetResponseElementMAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementMAmendment((array)$data['a_amendment']) : null;
