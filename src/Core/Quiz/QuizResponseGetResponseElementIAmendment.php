...
class QuizResponseGetResponseElementIAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementIAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementIAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementIAmendmentChange((array)$data['a_change']) : null;
