...
class QuizElementGetResponseElementC
{
     ...
     *
     * @var QuizElementGetResponseElementCAmendment|null
     */
    public ?QuizElementGetResponseElementCAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementCAmendment((array)$data['a_amendment']) : null;
