...
class QuizResponseGetResponseElementH
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementHAmendment|null
     */
    public ?QuizResponseGetResponseElementHAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementHAmendment((array)$data['a_amendment']) : null;
