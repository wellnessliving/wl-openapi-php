...
class QuizResponseGetResponseElementE
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementEAmendment|null
     */
    public ?QuizResponseGetResponseElementEAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementEAmendment((array)$data['a_amendment']) : null;
