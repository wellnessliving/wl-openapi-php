...
class QuizResponseGetResponseElementL
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementLAmendment|null
     */
    public ?QuizResponseGetResponseElementLAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementLAmendment((array)$data['a_amendment']) : null;
