...
class QuizResponseGetResponseElementC
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementCAmendment|null
     */
    public ?QuizResponseGetResponseElementCAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementCAmendment((array)$data['a_amendment']) : null;
