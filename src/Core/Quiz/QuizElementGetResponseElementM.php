...
class QuizElementGetResponseElementM
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementMAmendment|null
     */
    public ?QuizElementGetResponseElementMAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementMAmendment((array)$data['a_amendment']) : null;
