...
class QuizResponseGetResponseElementCAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementCAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementCAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementCAmendmentChange((array)$data['a_change']) : null;
