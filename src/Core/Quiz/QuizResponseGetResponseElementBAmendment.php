...
class QuizResponseGetResponseElementBAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementBAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementBAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementBAmendmentChange((array)$data['a_change']) : null;
