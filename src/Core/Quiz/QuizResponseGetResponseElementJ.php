...
class QuizResponseGetResponseElementJ
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementJAmendment|null
     */
    public ?QuizResponseGetResponseElementJAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementJAmendment((array)$data['a_amendment']) : null;
