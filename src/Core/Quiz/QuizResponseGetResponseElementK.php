...
class QuizResponseGetResponseElementK
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementKAmendment|null
     */
    public ?QuizResponseGetResponseElementKAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementKAmendment((array)$data['a_amendment']) : null;
