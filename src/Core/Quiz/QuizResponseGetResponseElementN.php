...
class QuizResponseGetResponseElementN
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementNAmendment|null
     */
    public ?QuizResponseGetResponseElementNAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementNAmendment((array)$data['a_amendment']) : null;
