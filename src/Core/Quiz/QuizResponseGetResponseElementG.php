...
class QuizResponseGetResponseElementG
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementGAmendment|null
     */
    public ?QuizResponseGetResponseElementGAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementGAmendment((array)$data['a_amendment']) : null;
