...
class QuizResponseGetResponseElementMAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementMAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementMAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementMAmendmentChange((array)$data['a_change']) : null;
