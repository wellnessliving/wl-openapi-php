...
class QuizResponseGetResponseElementNAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementNAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementNAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementNAmendmentChange((array)$data['a_change']) : null;
