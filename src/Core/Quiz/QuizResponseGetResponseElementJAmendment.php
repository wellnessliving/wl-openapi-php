...
class QuizResponseGetResponseElementJAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementJAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementJAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementJAmendmentChange((array)$data['a_change']) : null;
