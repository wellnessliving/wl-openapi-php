...
class QuizResponseGetResponseElementB
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementBAmendment|null
     */
    public ?QuizResponseGetResponseElementBAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementBAmendment((array)$data['a_amendment']) : null;
