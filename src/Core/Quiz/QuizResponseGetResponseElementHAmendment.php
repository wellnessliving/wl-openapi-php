...
class QuizResponseGetResponseElementHAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementHAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementHAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementHAmendmentChange((array)$data['a_change']) : null;
