...
class QuizResponseGetResponseElementFAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementFAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementFAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementFAmendmentChange((array)$data['a_change']) : null;
