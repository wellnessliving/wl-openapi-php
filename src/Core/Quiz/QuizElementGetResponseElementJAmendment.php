...
class QuizElementGetResponseElementJAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementJAmendmentChange|null
     */
    public ?QuizElementGetResponseElementJAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementJAmendmentChange((array)$data['a_change']) : null;
