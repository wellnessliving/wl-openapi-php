...
class QuizResponseGetResponseElementI
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementIAmendment|null
     */
    public ?QuizResponseGetResponseElementIAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementIAmendment((array)$data['a_amendment']) : null;
