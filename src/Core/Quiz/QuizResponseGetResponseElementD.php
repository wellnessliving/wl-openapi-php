...
class QuizResponseGetResponseElementD
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementDAmendment|null
     */
    public ?QuizResponseGetResponseElementDAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementDAmendment((array)$data['a_amendment']) : null;
