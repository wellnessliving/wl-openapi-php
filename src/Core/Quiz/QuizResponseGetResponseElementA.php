...
class QuizResponseGetResponseElementA
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementAAmendment|null
     */
    public ?QuizResponseGetResponseElementAAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementAAmendment((array)$data['a_amendment']) : null;
