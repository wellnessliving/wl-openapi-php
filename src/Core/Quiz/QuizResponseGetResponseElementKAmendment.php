...
class QuizResponseGetResponseElementKAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementKAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementKAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementKAmendmentChange((array)$data['a_change']) : null;
