...
class QuizResponseGetResponseElementLAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementLAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementLAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementLAmendmentChange((array)$data['a_change']) : null;
