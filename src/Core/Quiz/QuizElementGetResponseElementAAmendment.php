...
class QuizElementGetResponseElementAAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementAAmendmentChange|null
     */
    public ?QuizElementGetResponseElementAAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementAAmendmentChange((array)$data['a_change']) : null;
