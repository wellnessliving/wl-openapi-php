...
class QuizResponseGetResponseElementAAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementAAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementAAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementAAmendmentChange((array)$data['a_change']) : null;
