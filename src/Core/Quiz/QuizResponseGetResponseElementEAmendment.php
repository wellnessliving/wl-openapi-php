...
class QuizResponseGetResponseElementEAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementEAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementEAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementEAmendmentChange((array)$data['a_change']) : null;
