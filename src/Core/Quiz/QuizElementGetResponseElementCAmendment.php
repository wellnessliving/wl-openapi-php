...
class QuizElementGetResponseElementCAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementCAmendmentChange|null
     */
    public ?QuizElementGetResponseElementCAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementCAmendmentChange((array)$data['a_change']) : null;
