...
class QuizResponseGetResponseElementDAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementDAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementDAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementDAmendmentChange((array)$data['a_change']) : null;
