...
class QuizResponseGetResponseElementF
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizResponseGetResponseElementFAmendment|null
     */
    public ?QuizResponseGetResponseElementFAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizResponseGetResponseElementFAmendment((array)$data['a_amendment']) : null;
