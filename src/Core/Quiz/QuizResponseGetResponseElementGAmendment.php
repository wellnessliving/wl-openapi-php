...
class QuizResponseGetResponseElementGAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizResponseGetResponseElementGAmendmentChange|null
     */
    public ?QuizResponseGetResponseElementGAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizResponseGetResponseElementGAmendmentChange((array)$data['a_change']) : null;
