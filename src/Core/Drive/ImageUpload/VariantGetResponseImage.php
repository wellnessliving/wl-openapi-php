...
class VariantGetResponseImage
{
    ...
    /**
     * Whether thumbnail is a resized variant of original image. If set to `false`, value returned in
     * `url-thumbnail` equals value in `url-view`.
     *
     * @var bool|null
     */
     ...
     * arguments, image thumbnail as created, and a link to this thumbnail is returned.
