...
class ImageUploadGetResponse
{
     ...
     */
    public ?ImageUploadGetResponseTextEmpty $a_text_empty = null;
    ...
    {
        $this->a_text_empty = isset($data['a_text_empty']) ? new ImageUploadGetResponseTextEmpty((array)$data['a_text_empty']) : null;
