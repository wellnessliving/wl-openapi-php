...
class ImageUploadPostResponseImage
{
    /**
     * Information about the text on the empty upload image.
     *
     * @var ImageUploadPostResponseImageTextEmpty|null
     */
    public ?ImageUploadPostResponseImageTextEmpty $a_text_empty = null;
    ...
    {
        $this->a_text_empty = isset($data['a_text_empty']) ? new ImageUploadPostResponseImageTextEmpty((array)$data['a_text_empty']) : null;
