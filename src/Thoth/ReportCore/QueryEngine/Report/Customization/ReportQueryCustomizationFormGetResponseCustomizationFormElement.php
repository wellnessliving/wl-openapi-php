...
class ReportQueryCustomizationFormGetResponseCustomizationFormElement
{
    /**
     * Element fields keyed by field alias. Each field has the following structure:
     *
     * @var ReportQueryCustomizationFormGetResponseCustomizationFormElementField|null
     */
    public ?ReportQueryCustomizationFormGetResponseCustomizationFormElementField $a_field = null;
    ...
    {
        $this->a_field = isset($data['a_field']) ? new ReportQueryCustomizationFormGetResponseCustomizationFormElementField((array)$data['a_field']) : null;
