...
class QueryPostResponse
{
     ...
     * [QueryApi::$a_row](/Thoth/ReportCore/Generator/Query.json).
     *
     * @var string[]|null
     */
     ...
     *
     * Indexes of the columns correspond columns in [QueryApi::$a_field](/Thoth/ReportCore/Generator/Query.json).
     *
     * @var string[][]|null
     */
     ...
     *
     * Value is index in [QueryApi::$a_row](/Thoth/ReportCore/Generator/Query.json).
     *
