...
class ClickTrackingGetResponseRowList
{
     ...
     * @var int|null
     */
    public ?int $i_click_unique = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->i_click_unique = isset($data['i_click_unique']) ? (int)$data['i_click_unique'] : null;
        $this->i_click_total = isset($data['i_click_total']) ? (int)$data['i_click_total'] : null;
        $this->i_click_rate = isset($data['i_click_rate']) ? (int)$data['i_click_rate'] : null;
