...
class DebtListGetRequest
{
     ...
     *
     * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) has been specified, only debts added after the
     * start date will be returned.
     * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) is also `null`, this will return debts from
     * the previous month.
     *
     * @var string|null
     */
     ...
     *
     * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) has been specified will return debts added
