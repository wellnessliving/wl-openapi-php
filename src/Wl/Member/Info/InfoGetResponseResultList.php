...
class InfoGetResponseResultList
{
    /**
     * Additional user's information.
     *
     * @var InfoGetResponseResultListInfo|null
     */
    public ?InfoGetResponseResultListInfo $a_info = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new InfoGetResponseResultListInfo((array)$data['a_info']) : null;
