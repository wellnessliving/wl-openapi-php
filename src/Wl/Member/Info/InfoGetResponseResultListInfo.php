...
class InfoGetResponseResultListInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var InfoGetResponseResultListInfoIcon|null
     */
    public ?InfoGetResponseResultListInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var InfoGetResponseResultListInfoVaccinationStatus|null
     */
    public ?InfoGetResponseResultListInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var InfoGetResponseResultListInfoNote|null
     */
    public ?InfoGetResponseResultListInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new InfoGetResponseResultListInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new InfoGetResponseResultListInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new InfoGetResponseResultListInfoNote((array)$data['a_note']) : null;
