...
class InfoGetResponseInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var InfoGetResponseInfoIcon|null
     */
    public ?InfoGetResponseInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var InfoGetResponseInfoVaccinationStatus|null
     */
    public ?InfoGetResponseInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var InfoGetResponseInfoNote|null
     */
    public ?InfoGetResponseInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new InfoGetResponseInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new InfoGetResponseInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new InfoGetResponseInfoNote((array)$data['a_note']) : null;
