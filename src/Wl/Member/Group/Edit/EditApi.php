...
class EditApi
{
    ...
    {
        return new EditApiGetResponse($this->client->request('/Wl/Member/Group/Edit/Edit.json', $this->params(), 'GET'));
    }
    ...
    {
        return new EditApiPostResponse($this->client->request('/Wl/Member/Group/Edit/Edit.json', $this->params(), 'POST'));
    }
    ...
    {
        return new EditApiPutResponse($this->client->request('/Wl/Member/Group/Edit/Edit.json', $this->params(), 'PUT'));
    }
