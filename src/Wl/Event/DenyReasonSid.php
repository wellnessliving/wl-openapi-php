 ...
 *
 * Note: Avoid adding any constants to this SID. Add them to the base class
 * [DenyReasonSid](#/components/schemas/Wl.Schedule.ClassView.DenyReasonSid)
 * instead. Because if you add them here, and new constants are later added to the base class, we could have ID
 * conflicts.
