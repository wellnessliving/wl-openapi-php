...
class ElementGetResponseSchedule
{
    /**
     ...
     *
     * @var ElementGetResponseScheduleRepeat|null
     */
    public ?ElementGetResponseScheduleRepeat $a_repeat = null;

    /**
     * A list of staff members who conduct the session. Every element has the following next keys:
     *
     * @var ElementGetResponseScheduleStaff|null
     */
    public ?ElementGetResponseScheduleStaff $a_staff = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_repeat = isset($data['a_repeat']) ? new ElementGetResponseScheduleRepeat((array)$data['a_repeat']) : null;
        $this->a_staff = isset($data['a_staff']) ? new ElementGetResponseScheduleStaff((array)$data['a_staff']) : null;
