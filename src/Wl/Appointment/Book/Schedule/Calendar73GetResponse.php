...
class Calendar73GetResponse
{
     ...
     *
     * @var Calendar73GetResponseTime|null
     */
    public ?Calendar73GetResponseTime $a_time = null;

    /**
     * Information about timezone.
     *
     * @var Calendar73GetResponseTimezoneData|null
     */
    public ?Calendar73GetResponseTimezoneData $a_timezone_data = null;
     ...
     *
     * @var Calendar73GetResponseWeekName|null
     */
    public ?Calendar73GetResponseWeekName $a_week_name = null;
    ...
    {
        $this->a_date = isset($data['a_date']) ? array_map(static fn ($item) => new Calendar73GetResponseDate((array)$item), (array)$data['a_date']) : null;
        $this->a_time = isset($data['a_time']) ? new Calendar73GetResponseTime((array)$data['a_time']) : null;
        $this->a_timezone_data = isset($data['a_timezone_data']) ? new Calendar73GetResponseTimezoneData((array)$data['a_timezone_data']) : null;
        $this->a_week_name = isset($data['a_week_name']) ? new Calendar73GetResponseWeekName((array)$data['a_week_name']) : null;
