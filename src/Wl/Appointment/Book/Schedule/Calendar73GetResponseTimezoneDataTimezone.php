...
class Calendar73GetResponseTimezoneDataTimezone
{
    /**
     * Timezone order.
     *
    ...
    /**
     * `true` for selected timezone - from {@link \WlSdk\Wl\Appointment\Book\Schedule\Calendar} param or client's
     * default timezone when param not set.
     *
     * @var bool|null
     */
