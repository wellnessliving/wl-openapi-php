...
class DayTime73
{
     ...
     *
     * @return DayTime73GetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(DayTime73GetRequest $request): DayTime73GetResponse
    {
        return new DayTime73GetResponse($this->client->request('/Wl/Appointment/Book/Schedule/DayTime73.json', $request->params(), 'GET'));
    }
}
