 ...
 * Response from GET
 */
class DayTime73GetResponse
{
    /**
     * An array with a schedule of available appointment booking times.
     *
     * @var DayTime73GetResponseTime|null
     */
    public ?DayTime73GetResponseTime $a_time = null;
    ...
    {
        $this->a_time = isset($data['a_time']) ? new DayTime73GetResponseTime((array)$data['a_time']) : null;
