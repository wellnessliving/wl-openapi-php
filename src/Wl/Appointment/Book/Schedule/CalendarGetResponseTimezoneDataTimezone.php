...
class CalendarGetResponseTimezoneDataTimezone
{
    ...
    /**
     * `true` for selected timezone - from [CalendarApi::$k_timezone](/Wl/Appointment/Book/Schedule/Calendar.json)
     * param or client's default timezone when param not set.
     *
     * @var bool|null
     */
