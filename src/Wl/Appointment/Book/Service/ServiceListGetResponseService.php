...
class ServiceListGetResponseService
{
     ...
     *
     * @var ServiceListGetResponseServiceDirectLink|null
     */
    public ?ServiceListGetResponseServiceDirectLink $a_direct_link = null;
     ...
     *
     * @var ServiceListGetResponseServiceConfig|null
     */
    public ?ServiceListGetResponseServiceConfig $a_config = null;

    /**
     * Information about the appointment image. An array with the following values:
     *
     * @var ServiceListGetResponseServiceImage|null
     */
    public ?ServiceListGetResponseServiceImage $a_image = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_direct_link = isset($data['a_direct_link']) ? new ServiceListGetResponseServiceDirectLink((array)$data['a_direct_link']) : null;
        $this->a_config = isset($data['a_config']) ? new ServiceListGetResponseServiceConfig((array)$data['a_config']) : null;
        $this->a_image = isset($data['a_image']) ? new ServiceListGetResponseServiceImage((array)$data['a_image']) : null;
