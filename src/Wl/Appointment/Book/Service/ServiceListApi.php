...
class ServiceListApi
{
     ...
     * @deprecated
     *
     * @return ServiceListApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): ServiceListApiGetResponse
    {
        return new ServiceListApiGetResponse($this->client->request('/Wl/Appointment/Book/Service/ServiceList.json', $this->params(), 'GET'));
    }
