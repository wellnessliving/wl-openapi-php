...
class ProductGetResponseProduct
{
    /**
     * Information about first image connected to the product.
     *
     * @var ProductGetResponseProductLogo|null
     */
    public ?ProductGetResponseProductLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new ProductGetResponseProductLogo((array)$data['a_logo']) : null;
