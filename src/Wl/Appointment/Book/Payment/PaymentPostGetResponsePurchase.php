...
class PaymentPostGetResponsePurchase
{
    /**
     ...
     *
     * @var PaymentPostGetResponsePurchaseTax|null
     */
    public ?PaymentPostGetResponsePurchaseTax $a_tax = null;
    ...
    {
        $this->a_tax = isset($data['a_tax']) ? new PaymentPostGetResponsePurchaseTax((array)$data['a_tax']) : null;
