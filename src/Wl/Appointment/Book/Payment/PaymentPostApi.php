...
class PaymentPostApi
{
     ...
     *
     * @return PaymentPostApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): PaymentPostApiGetResponse
    {
        return new PaymentPostApiGetResponse($this->client->request('/Wl/Appointment/Book/Payment/PaymentPost.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return PaymentPostApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): PaymentPostApiPostResponse
    {
        return new PaymentPostApiPostResponse($this->client->request('/Wl/Appointment/Book/Payment/PaymentPost.json', $this->params(), 'POST'));
    }
