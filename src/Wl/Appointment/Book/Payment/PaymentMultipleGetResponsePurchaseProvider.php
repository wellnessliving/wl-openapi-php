...
class PaymentMultipleGetResponsePurchaseProvider
{
    /**
     ...
     *
     * @var PaymentMultipleGetResponsePurchaseProviderTax|null
     */
    public ?PaymentMultipleGetResponsePurchaseProviderTax $a_tax = null;
    ...
    {
        $this->a_tax = isset($data['a_tax']) ? new PaymentMultipleGetResponsePurchaseProviderTax((array)$data['a_tax']) : null;
