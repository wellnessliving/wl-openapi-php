...
class Purchase72Api
{
     ...
     *
     * @return Purchase72ApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): Purchase72ApiGetResponse
    {
        return new Purchase72ApiGetResponse($this->client->request('/Wl/Appointment/Book/Purchase/Purchase72.json', $this->params(), 'GET'));
    }
