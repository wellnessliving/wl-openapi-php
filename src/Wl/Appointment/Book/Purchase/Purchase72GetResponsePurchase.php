...
class Purchase72GetResponsePurchase
{
    /**
     ...
     *
     * @var Purchase72GetResponsePurchaseImage|null
     */
    public ?Purchase72GetResponsePurchaseImage $a_image = null;

    /**
     * The set of calculated values for payment:
     *
     * @var Purchase72GetResponsePurchasePayment|null
     */
    public ?Purchase72GetResponsePurchasePayment $a_payment = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new Purchase72GetResponsePurchaseImage((array)$data['a_image']) : null;
        $this->a_payment = isset($data['a_payment']) ? new Purchase72GetResponsePurchasePayment((array)$data['a_payment']) : null;
