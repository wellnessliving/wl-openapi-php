...
class ServiceApi
{
     ...
     *
     * @return ServiceApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): ServiceApiGetResponse
    {
        return new ServiceApiGetResponse($this->client->request('/Wl/Appointment/Book/Asset/Service/Service.json', $this->params(), 'GET'));
    }
