...
class ServiceGetResponseResourceTypeResourceImage
{
    /**
     * Image data.
     *
     * @var ServiceGetResponseResourceTypeResourceImageImage|null
     */
    public ?ServiceGetResponseResourceTypeResourceImageImage $a_image = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new ServiceGetResponseResourceTypeResourceImageImage((array)$data['a_image']) : null;
