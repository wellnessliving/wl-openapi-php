...
class ConflictGetResponse
{
     ...
     *
     * @var ConflictGetResponseConflict[]|null
     */
    ...
    {
        $this->a_conflict = isset($data['a_conflict']) ? array_map(static fn ($item) => new ConflictGetResponseConflict((array)$item), (array)$data['a_conflict']) : null;
