...
class FinishMultiple
{
     ...
     * [FinishMultipleApi::$a_book_data](/Wl/Appointment/Book/Finish/FinishMultiple.json),
     ...
     *  details in [FinishMultipleApi::$a_user](/Wl/Appointment/Book/Finish/FinishMultiple.json) when no UID is
     * provided.
     *
