...
class StaffView74GetResponseResultListStaffPhoto
{
     ...
     * Image data.
     *
     * @var StaffView74GetResponseResultListStaffPhotoImage|null
     */
    public ?StaffView74GetResponseResultListStaffPhotoImage $a_image = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new StaffView74GetResponseResultListStaffPhotoImage((array)$data['a_image']) : null;
