...
class StaffViewGetResponseStaff
{
    /**
     ...
     * Staff's photo.
     *
     * @var StaffViewGetResponseStaffPhoto|null
     */
    public ?StaffViewGetResponseStaffPhoto $a_photo = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_photo = isset($data['a_photo']) ? new StaffViewGetResponseStaffPhoto((array)$data['a_photo']) : null;
