...
class StaffViewApi
{
     ...
     * @deprecated
     *
     * @return StaffViewApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): StaffViewApiGetResponse
    {
        return new StaffViewApiGetResponse($this->client->request('/Wl/Staff/StaffView/StaffView.json', $this->params(), 'GET'));
    }
