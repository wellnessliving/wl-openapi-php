...
{
    /**
     * List of businesses which are available in given application. Primary keys in RsBusinessSql table.
    ...
    /**
     * List of businesses keys, which are connected to franchise. Primary keys in RsBusinessSql table.
     *
    ...
    /**
     * List of business franchisee keys. Primary keys in RsBusinessSql table.
    ...
    /**
     * Settings of splash screen customization for business Wl_Session_EnvironmentModel.k_business:
    ...
    /**
     * Local date with time now in current location `k_location`.
     *
     * @var string|null
     */
    ...
    /**
     * Whether the merchant is configured for the client's home location or for business `k_business`.
     *
     * @var bool|null
     */
    ...
    /**
     * Determines if a business has multiple locations. See rs_business_location_multiple().
     *
     * @var bool|null
     */
    ...
    /**
     * Key of business to be set as current. Primary key in table RsBusinessSql.
     *
     * @var string|null
     */
    ...
    /**
     * Currency key.
     * Primary key in the RsCurrencySql table.
     *
     * @var string|null
     */
    ...
    /**
     * Key of location to be set as current. Primary key in table RsLocationSql.
     *
     * @var string|null
     */
