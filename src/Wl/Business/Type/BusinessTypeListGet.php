...
class BusinessTypeListGet
{
     ...
     *
     * @return BusinessTypeListGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(BusinessTypeListGetRequest $request): BusinessTypeListGetResponse
    {
        return new BusinessTypeListGetResponse($this->client->request('/Wl/Business/Type/BusinessTypeList.json', $request->params(), 'GET'));
    }
}
