...
class PurchaseItemListGetResponse
{
     ...
     *
     * @var PurchaseItemListGetResponseAdditionalInfo|null
     */
    public ?PurchaseItemListGetResponseAdditionalInfo $a_additional_info = null;

    /**
     * Logo details array. Business logo:
     *
     * @var PurchaseItemListGetResponseLogo|null
     */
    public ?PurchaseItemListGetResponseLogo $a_logo = null;
    ...
    {
        $this->a_additional_info = isset($data['a_additional_info']) ? new PurchaseItemListGetResponseAdditionalInfo((array)$data['a_additional_info']) : null;
        $this->a_logo = isset($data['a_logo']) ? new PurchaseItemListGetResponseLogo((array)$data['a_logo']) : null;
