...
class DiscountCodeEditApi
{
     ...
     *
     * @return DiscountCodeEditApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): DiscountCodeEditApiGetResponse
    {
        return new DiscountCodeEditApiGetResponse($this->client->request('/Wl/Discount/Code/Edit/DiscountCodeEdit.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return DiscountCodeEditApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): DiscountCodeEditApiPostResponse
    {
        return new DiscountCodeEditApiPostResponse($this->client->request('/Wl/Discount/Code/Edit/DiscountCodeEdit.json', $this->params(), 'POST'));
    }
     ...
     *
     * @return DiscountCodeEditApiPutResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function put(): DiscountCodeEditApiPutResponse
    {
        return new DiscountCodeEditApiPutResponse($this->client->request('/Wl/Discount/Code/Edit/DiscountCodeEdit.json', $this->params(), 'PUT'));
    }
