...
class EnrollmentFieldListGetResponseFieldListField
{
    /**
     * Additional configuration for the field:
     *
     * @var EnrollmentFieldListGetResponseFieldListFieldConfig|null
     */
    public ?EnrollmentFieldListGetResponseFieldListFieldConfig $a_config = null;
    ...
    {
        $this->a_config = isset($data['a_config']) ? new EnrollmentFieldListGetResponseFieldListFieldConfig((array)$data['a_config']) : null;
