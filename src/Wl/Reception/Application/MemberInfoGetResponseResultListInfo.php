...
class MemberInfoGetResponseResultListInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var MemberInfoGetResponseResultListInfoIcon|null
     */
    public ?MemberInfoGetResponseResultListInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var MemberInfoGetResponseResultListInfoVaccinationStatus|null
     */
    public ?MemberInfoGetResponseResultListInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var MemberInfoGetResponseResultListInfoNote|null
     */
    public ?MemberInfoGetResponseResultListInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new MemberInfoGetResponseResultListInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new MemberInfoGetResponseResultListInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new MemberInfoGetResponseResultListInfoNote((array)$data['a_note']) : null;
