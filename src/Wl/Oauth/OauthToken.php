...
class OauthToken
{
    ...
    {
        return new OauthTokenGetResponse($this->client->request('/Wl/Oauth/OauthToken.json', $request->params(), 'GET'));
    }
    ...
    {
        return new OauthTokenPostResponse($this->client->request('/Wl/Oauth/OauthToken.json', $request->params(), 'POST'));
    }
}
