...
class PageDataApi
{
     ...
     *
     * @return PageDataApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): PageDataApiGetResponse
    {
        return new PageDataApiGetResponse($this->client->request('/Wl/Report/PageData.json', $this->params(), 'GET'));
    }
