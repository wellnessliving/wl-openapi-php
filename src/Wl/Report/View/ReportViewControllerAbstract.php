 ...
 * - 1272 (`Wl\Collector\Report\DebtReportController`): Controller for
 * [DebtReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report.
 * - 1298 (`Wl\Collector\Report\TransactionCollectorReportController`): Controller for
 * [TransactionCollectorReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report.
 * - 1291 (`Wl\Collector\Report\TransactionReportController`): Controller for
 * [TransactionReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report.
 ...
 *   !!!IMPORTANT!!!
 *
 *   If this class has to be renamed again, there are unapparent usages of this class across the project. Search for
 * regex
 *   `[^|]Thoth.Report.SalesReport.Client.TransactionAllItemStaffClientReport`
 *   You will come across usages in MapProfile that also need to be adjusted.
 ...
 *   If this class has to be renamed again, there are unapparent usages of this class across the project. Search for
 * regex
 *   `[^|]Thoth.Report.SalesReport.Client.TransactionAllPaymentClientReport`
 *   You will come across usages in ProfileMenu that also need to be adjusted.
 ...
 *   If this class has to be renamed again, there are unapparent usages of this class across the project. Search for
 * regex
 *   `[^|]Thoth.Report.SalesReport.Client.TransactionAllPaymentStaffClientReport`
 *   You will come across usages in MapProfile that also need to be adjusted.
 ...
 * representation.
 * - 2229 (`Thoth\ReportCore\QueryEngine\Report\ReportQueryReportController`): View controller for
 * [ReportQueryReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract).
 *
 *   Renders a registry-stored SQL report in table mode.
 *   The query key is passed via the encoded `'s'` URL parameter inside
 *    `a_filter`.`o_report_query`.`k_report_query`, encoded with UrlEncode::encode().
 ...
 * - 1162 (`Wl\Business\Account\Revenue\Processing\RevenueProcessingReportController`): Controller for
 * [RevenueProcessingReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract).
...
class ReportViewControllerAbstract
{
    ...
    /** Controller for [DebtReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report. */
    public const DebtReportController = 1272;

    /** Controller for [TransactionCollectorReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report. */
    public const TransactionCollectorReportController = 1298;

    /** Controller for [TransactionReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract) report. */
    ...
    /** View controller for [ReportQueryReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract). */
    ...
    /** Controller for [RevenueProcessingReport](#/components/schemas/Thoth.ReportCore.Generator.ReportGeneratorReportAbstract). */
