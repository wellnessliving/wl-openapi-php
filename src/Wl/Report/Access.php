...
class Access
{
     ...
     * Checks access to given report.
     *
     * Accepts either [AccessApi::$id_report](/Wl/Report/Access.json) (first-generation reports) or
     * [AccessApi::$cid_report](/Wl/Report/Access.json) (second-generation reports), but not both,
