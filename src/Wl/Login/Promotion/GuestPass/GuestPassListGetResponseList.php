...
class GuestPassListGetResponseList
{
    /**
     * Thumbnail image data for the guest promotion.
     *
     * @var GuestPassListGetResponseListImage|null
     */
    public ?GuestPassListGetResponseListImage $a_image = null;

    /**
     * Start and end dates of the current reset period.
     *   `null` if there is no reset period or the reset date is unavailable.
     *
     * @var GuestPassListGetResponseListPeriodDl|null
     */
    public ?GuestPassListGetResponseListPeriodDl $a_period_dl = null;

    /**
     * Guest pass settings.
     * Empty array when the guest pass has no settings (class-type passes).
     *
     * @var GuestPassListGetResponseListSettings|null
     */
    public ?GuestPassListGetResponseListSettings $a_settings = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new GuestPassListGetResponseListImage((array)$data['a_image']) : null;
        $this->a_period_dl = isset($data['a_period_dl']) ? new GuestPassListGetResponseListPeriodDl((array)$data['a_period_dl']) : null;
        $this->a_settings = isset($data['a_settings']) ? new GuestPassListGetResponseListSettings((array)$data['a_settings']) : null;
