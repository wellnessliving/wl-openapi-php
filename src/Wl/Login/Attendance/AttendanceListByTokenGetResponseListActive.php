...
class AttendanceListByTokenGetResponseListActive
{
    /**
     * Information about member.
     *
     * @var AttendanceListByTokenGetResponseListActiveInfo|null
     */
    public ?AttendanceListByTokenGetResponseListActiveInfo $a_info = null;

    /**
     * Information about the user's photo. The information returned has the following structure:
     *
     * @var AttendanceListByTokenGetResponseListActivePhoto|null
     */
    public ?AttendanceListByTokenGetResponseListActivePhoto $a_photo = null;

    /**
     * Information about a user's current progress. By default, this information isn't sent.
     *
     * @var AttendanceListByTokenGetResponseListActiveProgress|null
     */
    public ?AttendanceListByTokenGetResponseListActiveProgress $a_progress = null;

    /**
     * Quiz information that concerns current visit.
     *
     * @var AttendanceListByTokenGetResponseListActiveQuiz|null
     */
    public ?AttendanceListByTokenGetResponseListActiveQuiz $a_quiz = null;

    /**
     * A list of information for any associated resources for this visit. Each element:
     *
     * @var AttendanceListByTokenGetResponseListActiveResource|null
     */
    public ?AttendanceListByTokenGetResponseListActiveResource $a_resource = null;
     ...
     *
     * @var AttendanceListByTokenGetResponseListActiveWaitConfirm|null
     */
    public ?AttendanceListByTokenGetResponseListActiveWaitConfirm $a_wait_confirm = null;

    /**
     * A list of information pertaining to the client's wearables.
     *
     * @var AttendanceListByTokenGetResponseListActiveWearable|null
     */
    public ?AttendanceListByTokenGetResponseListActiveWearable $a_wearable = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new AttendanceListByTokenGetResponseListActiveInfo((array)$data['a_info']) : null;
        $this->a_photo = isset($data['a_photo']) ? new AttendanceListByTokenGetResponseListActivePhoto((array)$data['a_photo']) : null;
        $this->a_progress = isset($data['a_progress']) ? new AttendanceListByTokenGetResponseListActiveProgress((array)$data['a_progress']) : null;
        $this->a_quiz = isset($data['a_quiz']) ? new AttendanceListByTokenGetResponseListActiveQuiz((array)$data['a_quiz']) : null;
        $this->a_resource = isset($data['a_resource']) ? new AttendanceListByTokenGetResponseListActiveResource((array)$data['a_resource']) : null;
        $this->a_wait_confirm = isset($data['a_wait_confirm']) ? new AttendanceListByTokenGetResponseListActiveWaitConfirm((array)$data['a_wait_confirm']) : null;
        $this->a_wearable = isset($data['a_wearable']) ? new AttendanceListByTokenGetResponseListActiveWearable((array)$data['a_wearable']) : null;
