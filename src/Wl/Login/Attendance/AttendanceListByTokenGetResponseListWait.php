...
class AttendanceListByTokenGetResponseListWait
{
    /**
     * Information about member.
     *
     * @var AttendanceListByTokenGetResponseListWaitInfo|null
     */
    public ?AttendanceListByTokenGetResponseListWaitInfo $a_info = null;

    /**
     * Information about the user's photo. The information returned has the following structure:
     *
     * @var AttendanceListByTokenGetResponseListWaitPhoto|null
     */
    public ?AttendanceListByTokenGetResponseListWaitPhoto $a_photo = null;

    /**
     * Information about a user's current progress. By default, this information isn't sent.
     *
     * @var AttendanceListByTokenGetResponseListWaitProgress|null
     */
    public ?AttendanceListByTokenGetResponseListWaitProgress $a_progress = null;

    /**
     * Quiz information that concerns current visit.
     *
     * @var AttendanceListByTokenGetResponseListWaitQuiz|null
     */
    public ?AttendanceListByTokenGetResponseListWaitQuiz $a_quiz = null;

    /**
     * A list of information for any associated resources for this visit. Each element:
     *
     * @var AttendanceListByTokenGetResponseListWaitResource|null
     */
    public ?AttendanceListByTokenGetResponseListWaitResource $a_resource = null;
     ...
     *
     * @var AttendanceListByTokenGetResponseListWaitWaitConfirm|null
     */
    public ?AttendanceListByTokenGetResponseListWaitWaitConfirm $a_wait_confirm = null;

    /**
     * A list of information pertaining to the client's wearables.
     *
     * @var AttendanceListByTokenGetResponseListWaitWearable|null
     */
    public ?AttendanceListByTokenGetResponseListWaitWearable $a_wearable = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new AttendanceListByTokenGetResponseListWaitInfo((array)$data['a_info']) : null;
        $this->a_photo = isset($data['a_photo']) ? new AttendanceListByTokenGetResponseListWaitPhoto((array)$data['a_photo']) : null;
        $this->a_progress = isset($data['a_progress']) ? new AttendanceListByTokenGetResponseListWaitProgress((array)$data['a_progress']) : null;
        $this->a_quiz = isset($data['a_quiz']) ? new AttendanceListByTokenGetResponseListWaitQuiz((array)$data['a_quiz']) : null;
        $this->a_resource = isset($data['a_resource']) ? new AttendanceListByTokenGetResponseListWaitResource((array)$data['a_resource']) : null;
        $this->a_wait_confirm = isset($data['a_wait_confirm']) ? new AttendanceListByTokenGetResponseListWaitWaitConfirm((array)$data['a_wait_confirm']) : null;
        $this->a_wearable = isset($data['a_wearable']) ? new AttendanceListByTokenGetResponseListWaitWearable((array)$data['a_wearable']) : null;
