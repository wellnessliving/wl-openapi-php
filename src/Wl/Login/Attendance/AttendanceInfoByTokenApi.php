 ...
 */
class AttendanceInfoByTokenApi
{
    /**
     ...
     *
     * @return AttendanceInfoByTokenApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): AttendanceInfoByTokenApiGetResponse
    {
        return new AttendanceInfoByTokenApiGetResponse($this->client->request('/Wl/Login/Attendance/AttendanceInfoByToken.json', $this->params(), 'GET'));
    }
