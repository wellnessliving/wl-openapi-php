...
class AttendanceListGetResponseListActiveInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListGetResponseListActiveInfoIcon|null
     */
    public ?AttendanceListGetResponseListActiveInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListGetResponseListActiveInfoVaccinationStatus|null
     */
    public ?AttendanceListGetResponseListActiveInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListGetResponseListActiveInfoNote|null
     */
    public ?AttendanceListGetResponseListActiveInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListGetResponseListActiveInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListGetResponseListActiveInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new AttendanceListGetResponseListActiveInfoNote((array)$data['a_note']) : null;
