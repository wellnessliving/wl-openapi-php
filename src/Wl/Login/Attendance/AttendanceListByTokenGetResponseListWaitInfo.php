...
class AttendanceListByTokenGetResponseListWaitInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListByTokenGetResponseListWaitInfoIcon|null
     */
    public ?AttendanceListByTokenGetResponseListWaitInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListByTokenGetResponseListWaitInfoVaccinationStatus|null
     */
    public ?AttendanceListByTokenGetResponseListWaitInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListByTokenGetResponseListWaitInfoNote|null
     */
    public ?AttendanceListByTokenGetResponseListWaitInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListByTokenGetResponseListWaitInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListByTokenGetResponseListWaitInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
