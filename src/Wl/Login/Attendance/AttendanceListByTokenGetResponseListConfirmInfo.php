...
class AttendanceListByTokenGetResponseListConfirmInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListByTokenGetResponseListConfirmInfoIcon|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListByTokenGetResponseListConfirmInfoVaccinationStatus|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListByTokenGetResponseListConfirmInfoNote|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListByTokenGetResponseListConfirmInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListByTokenGetResponseListConfirmInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new AttendanceListByTokenGetResponseListConfirmInfoNote((array)$data['a_note']) : null;
