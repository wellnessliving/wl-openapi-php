...
class AttendanceListGetResponseListConfirmInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListGetResponseListConfirmInfoIcon|null
     */
    public ?AttendanceListGetResponseListConfirmInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListGetResponseListConfirmInfoVaccinationStatus|null
     */
    public ?AttendanceListGetResponseListConfirmInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListGetResponseListConfirmInfoNote|null
     */
    public ?AttendanceListGetResponseListConfirmInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListGetResponseListConfirmInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListGetResponseListConfirmInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new AttendanceListGetResponseListConfirmInfoNote((array)$data['a_note']) : null;
