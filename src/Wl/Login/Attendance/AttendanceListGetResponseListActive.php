...
class AttendanceListGetResponseListActive
{
    /**
     * Information about member.
     *
     * @var AttendanceListGetResponseListActiveInfo|null
     */
    public ?AttendanceListGetResponseListActiveInfo $a_info = null;

    /**
     * Information about the user's photo. The information returned has the following structure:
     *
     * @var AttendanceListGetResponseListActivePhoto|null
     */
    public ?AttendanceListGetResponseListActivePhoto $a_photo = null;

    /**
     * Information about a user's current progress. By default, this information isn't sent.
     *
     * @var AttendanceListGetResponseListActiveProgress|null
     */
    public ?AttendanceListGetResponseListActiveProgress $a_progress = null;

    /**
     * Quiz information that concerns current visit.
     *
     * @var AttendanceListGetResponseListActiveQuiz|null
     */
    public ?AttendanceListGetResponseListActiveQuiz $a_quiz = null;

    /**
     * A list of information for any associated resources for this visit. Each element:
     *
     * @var AttendanceListGetResponseListActiveResource|null
     */
    public ?AttendanceListGetResponseListActiveResource $a_resource = null;
     ...
     *
     * @var AttendanceListGetResponseListActiveWaitConfirm|null
     */
    public ?AttendanceListGetResponseListActiveWaitConfirm $a_wait_confirm = null;

    /**
     * A list of information pertaining to the client's wearables.
     *
     * @var AttendanceListGetResponseListActiveWearable|null
     */
    public ?AttendanceListGetResponseListActiveWearable $a_wearable = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new AttendanceListGetResponseListActiveInfo((array)$data['a_info']) : null;
        $this->a_photo = isset($data['a_photo']) ? new AttendanceListGetResponseListActivePhoto((array)$data['a_photo']) : null;
        $this->a_progress = isset($data['a_progress']) ? new AttendanceListGetResponseListActiveProgress((array)$data['a_progress']) : null;
        $this->a_quiz = isset($data['a_quiz']) ? new AttendanceListGetResponseListActiveQuiz((array)$data['a_quiz']) : null;
        $this->a_resource = isset($data['a_resource']) ? new AttendanceListGetResponseListActiveResource((array)$data['a_resource']) : null;
        $this->a_wait_confirm = isset($data['a_wait_confirm']) ? new AttendanceListGetResponseListActiveWaitConfirm((array)$data['a_wait_confirm']) : null;
        $this->a_wearable = isset($data['a_wearable']) ? new AttendanceListGetResponseListActiveWearable((array)$data['a_wearable']) : null;
