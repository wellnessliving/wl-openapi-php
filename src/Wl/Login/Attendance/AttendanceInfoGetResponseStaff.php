...
class AttendanceInfoGetResponseStaff
{
    /**
     * Data of staff member's photo. Empty if staff has no photo. Otherwise contains next keys:
     *
     * @var AttendanceInfoGetResponseStaffLogo|null
     */
    public ?AttendanceInfoGetResponseStaffLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new AttendanceInfoGetResponseStaffLogo((array)$data['a_logo']) : null;
