...
class AttendanceListGetResponseListWaitInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListGetResponseListWaitInfoIcon|null
     */
    public ?AttendanceListGetResponseListWaitInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListGetResponseListWaitInfoVaccinationStatus|null
     */
    public ?AttendanceListGetResponseListWaitInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListGetResponseListWaitInfoNote|null
     */
    public ?AttendanceListGetResponseListWaitInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListGetResponseListWaitInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListGetResponseListWaitInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new AttendanceListGetResponseListWaitInfoNote((array)$data['a_note']) : null;
