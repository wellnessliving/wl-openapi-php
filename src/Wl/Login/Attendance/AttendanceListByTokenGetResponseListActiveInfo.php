...
class AttendanceListByTokenGetResponseListActiveInfo
{
    /**
     * List of icons with additional information about business member.
     *
     * @var AttendanceListByTokenGetResponseListActiveInfoIcon|null
     */
    public ?AttendanceListByTokenGetResponseListActiveInfoIcon $a_icon = null;

    /**
     * Information about users vaccination status.
     *
     * @var AttendanceListByTokenGetResponseListActiveInfoVaccinationStatus|null
     */
    public ?AttendanceListByTokenGetResponseListActiveInfoVaccinationStatus $a_vaccination_status = null;

    /**
     * List of client's notes. Every element has keys:
     *
     * @var AttendanceListByTokenGetResponseListActiveInfoNote|null
     */
    public ?AttendanceListByTokenGetResponseListActiveInfoNote $a_note = null;
    ...
    {
        $this->a_icon = isset($data['a_icon']) ? new AttendanceListByTokenGetResponseListActiveInfoIcon((array)$data['a_icon']) : null;
        $this->a_vaccination_status = isset($data['a_vaccination_status']) ? new AttendanceListByTokenGetResponseListActiveInfoVaccinationStatus((array)$data['a_vaccination_status']) : null;
        $this->a_note = isset($data['a_note']) ? new AttendanceListByTokenGetResponseListActiveInfoNote((array)$data['a_note']) : null;
