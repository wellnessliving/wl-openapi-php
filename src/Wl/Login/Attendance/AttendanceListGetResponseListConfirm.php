...
class AttendanceListGetResponseListConfirm
{
     ...
     *
     * @var AttendanceListGetResponseListConfirmInfo|null
     */
    public ?AttendanceListGetResponseListConfirmInfo $a_info = null;

    /**
     * Information about the user's photo. The information returned has the following structure:
     *
     * @var AttendanceListGetResponseListConfirmPhoto|null
     */
    public ?AttendanceListGetResponseListConfirmPhoto $a_photo = null;

    /**
     * Information about a user's current progress. By default, this information isn't sent.
     *
     * @var AttendanceListGetResponseListConfirmProgress|null
     */
    public ?AttendanceListGetResponseListConfirmProgress $a_progress = null;

    /**
     * Quiz information that concerns current visit.
     *
     * @var AttendanceListGetResponseListConfirmQuiz|null
     */
    public ?AttendanceListGetResponseListConfirmQuiz $a_quiz = null;

    /**
     * A list of information for any associated resources for this visit. Each element:
     *
     * @var AttendanceListGetResponseListConfirmResource|null
     */
    public ?AttendanceListGetResponseListConfirmResource $a_resource = null;
     ...
     *
     * @var AttendanceListGetResponseListConfirmWaitConfirm|null
     */
    public ?AttendanceListGetResponseListConfirmWaitConfirm $a_wait_confirm = null;

    /**
     * A list of information pertaining to the client's wearables.
     *
     * @var AttendanceListGetResponseListConfirmWearable|null
     */
    public ?AttendanceListGetResponseListConfirmWearable $a_wearable = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new AttendanceListGetResponseListConfirmInfo((array)$data['a_info']) : null;
        $this->a_photo = isset($data['a_photo']) ? new AttendanceListGetResponseListConfirmPhoto((array)$data['a_photo']) : null;
        $this->a_progress = isset($data['a_progress']) ? new AttendanceListGetResponseListConfirmProgress((array)$data['a_progress']) : null;
        $this->a_quiz = isset($data['a_quiz']) ? new AttendanceListGetResponseListConfirmQuiz((array)$data['a_quiz']) : null;
        $this->a_resource = isset($data['a_resource']) ? new AttendanceListGetResponseListConfirmResource((array)$data['a_resource']) : null;
        $this->a_wait_confirm = isset($data['a_wait_confirm']) ? new AttendanceListGetResponseListConfirmWaitConfirm((array)$data['a_wait_confirm']) : null;
        $this->a_wearable = isset($data['a_wearable']) ? new AttendanceListGetResponseListConfirmWearable((array)$data['a_wearable']) : null;
