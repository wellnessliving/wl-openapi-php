...
class AttendanceInfoByTokenGetResponseResourceLayout
{
    /**
     ...
     *
     * @var AttendanceInfoByTokenGetResponseResourceLayoutClient|null
     */
    public ?AttendanceInfoByTokenGetResponseResourceLayoutClient $a_client = null;
    ...
    {
        $this->a_client = isset($data['a_client']) ? new AttendanceInfoByTokenGetResponseResourceLayoutClient((array)$data['a_client']) : null;
