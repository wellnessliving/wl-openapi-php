...
class AttendanceListByTokenGetResponseListConfirm
{
    /**
     * Information about member.
     *
     * @var AttendanceListByTokenGetResponseListConfirmInfo|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmInfo $a_info = null;

    /**
     * Information about the user's photo. The information returned has the following structure:
     *
     * @var AttendanceListByTokenGetResponseListConfirmPhoto|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmPhoto $a_photo = null;

    /**
     * Information about a user's current progress. By default, this information isn't sent.
     *
     * @var AttendanceListByTokenGetResponseListConfirmProgress|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmProgress $a_progress = null;

    /**
     * Quiz information that concerns current visit.
     *
     * @var AttendanceListByTokenGetResponseListConfirmQuiz|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmQuiz $a_quiz = null;

    /**
     * A list of information for any associated resources for this visit. Each element:
     *
     * @var AttendanceListByTokenGetResponseListConfirmResource|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmResource $a_resource = null;
     ...
     *
     * @var AttendanceListByTokenGetResponseListConfirmWaitConfirm|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmWaitConfirm $a_wait_confirm = null;

    /**
     * A list of information pertaining to the client's wearables.
     *
     * @var AttendanceListByTokenGetResponseListConfirmWearable|null
     */
    public ?AttendanceListByTokenGetResponseListConfirmWearable $a_wearable = null;
    ...
    {
        $this->a_info = isset($data['a_info']) ? new AttendanceListByTokenGetResponseListConfirmInfo((array)$data['a_info']) : null;
        $this->a_photo = isset($data['a_photo']) ? new AttendanceListByTokenGetResponseListConfirmPhoto((array)$data['a_photo']) : null;
        $this->a_progress = isset($data['a_progress']) ? new AttendanceListByTokenGetResponseListConfirmProgress((array)$data['a_progress']) : null;
        $this->a_quiz = isset($data['a_quiz']) ? new AttendanceListByTokenGetResponseListConfirmQuiz((array)$data['a_quiz']) : null;
        $this->a_resource = isset($data['a_resource']) ? new AttendanceListByTokenGetResponseListConfirmResource((array)$data['a_resource']) : null;
        $this->a_wait_confirm = isset($data['a_wait_confirm']) ? new AttendanceListByTokenGetResponseListConfirmWaitConfirm((array)$data['a_wait_confirm']) : null;
        $this->a_wearable = isset($data['a_wearable']) ? new AttendanceListByTokenGetResponseListConfirmWearable((array)$data['a_wearable']) : null;
