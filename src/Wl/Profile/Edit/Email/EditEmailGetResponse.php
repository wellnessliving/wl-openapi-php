...
class EditEmailGetResponse
{
     ...
     */
    public ?EditEmailGetResponseUser $a_user = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_user = isset($data['a_user']) ? new EditEmailGetResponseUser((array)$data['a_user']) : null;
