...
class EditByTokenGetResponseStructure
{
     ...
     *
     * @var \WlSdk\RsFieldTypeSid|null
     */
    public ?\WlSdk\RsFieldTypeSid $id_field_type = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->id_field_type = isset($data['id_field_type']) ? \WlSdk\RsFieldTypeSid::tryFrom((int)$data['id_field_type']) : null;
