...
class DeletePostResponseErrorInfo
{
    /**
     * List of reasons why client can not be deleted. Each value is:
     *
     * @var DeletePostResponseErrorInfoReason|null
     */
    public ?DeletePostResponseErrorInfoReason $a_reason = null;
    ...
    {
        $this->a_reason = isset($data['a_reason']) ? new DeletePostResponseErrorInfoReason((array)$data['a_reason']) : null;
