...
class ResponseListGetResponseQuizResponse
{
    ...
    /**
     * The place where the request to fill out the quiz form occurred. One of the
     ...
     * [ResponseStatusSid](#/components/schemas/Core.Quiz.Response.ResponseStatusSid) constants.
     *
     * @var int|null
     */
