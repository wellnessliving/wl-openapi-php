...
class AttendanceOverlapListPostResponseDateOverlap
{
     ...
     *
     * @var AttendanceOverlapListPostResponseDateOverlapVisitList|null
     */
    public ?AttendanceOverlapListPostResponseDateOverlapVisitList $a_visit_list = null;
    ...
    {
        $this->a_visit_list = isset($data['a_visit_list']) ? new AttendanceOverlapListPostResponseDateOverlapVisitList((array)$data['a_visit_list']) : null;
