 ...
 * Response from POST
 */
class CheckCurrentStockPostResponse
{
    /**
     * Current stock counts for products. Every element has next fields:
     *
     * @var CheckCurrentStockPostResponseCurrent|null
     */
    public ?CheckCurrentStockPostResponseCurrent $a_current = null;
    ...
    {
        $this->a_current = isset($data['a_current']) ? new CheckCurrentStockPostResponseCurrent((array)$data['a_current']) : null;
