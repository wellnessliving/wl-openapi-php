...
class PurchaseElementGetResponseConfigEventList
{
    /**
     * Discounts applied to the event, `null` if there are none. Every row has the next keys:
     *
     * @var PurchaseElementGetResponseConfigEventListDiscount|null
     */
    public ?PurchaseElementGetResponseConfigEventListDiscount $a_discount = null;
    ...
    {
        $this->a_discount = isset($data['a_discount']) ? new PurchaseElementGetResponseConfigEventListDiscount((array)$data['a_discount']) : null;
