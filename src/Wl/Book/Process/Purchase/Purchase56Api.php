...
class Purchase56Api
{
     ...
     * [PurchaseApi](/Wl/Book/Process/Purchase/Purchase.json).
     ...
     *
     * @return Purchase56ApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): Purchase56ApiGetResponse
    {
        return new Purchase56ApiGetResponse($this->client->request('/Wl/Book/Process/Purchase/Purchase56.json', $this->params(), 'GET'));
    }
