...
class Purchase56GetResponseLoginPromotion
{
    /**
     * Information about the Purchase Option with the following information:
     *
     * @var Purchase56GetResponseLoginPromotionLoginPromotionInfo|null
     */
    public ?Purchase56GetResponseLoginPromotionLoginPromotionInfo $a_login_promotion_info = null;
     ...
     *
     * @var Purchase56GetResponseLoginPromotionRestrict|null
     */
    public ?Purchase56GetResponseLoginPromotionRestrict $a_restrict = null;

    /**
     * Data about all restriction periods given as an array, where each record has the following structure:
     *
     * @var Purchase56GetResponseLoginPromotionRestrictData|null
     */
    public ?Purchase56GetResponseLoginPromotionRestrictData $a_restrict_data = null;
    ...
    /**
     * The program ID for Purchase Options. One of the [RsProgramSid](#/components/schemas/RsProgramSid) constants.
     *
     * @var int|null
     */
    ...
    {
        $this->a_login_promotion_info = isset($data['a_login_promotion_info']) ? new Purchase56GetResponseLoginPromotionLoginPromotionInfo((array)$data['a_login_promotion_info']) : null;
        ...
        $this->a_restrict = isset($data['a_restrict']) ? new Purchase56GetResponseLoginPromotionRestrict((array)$data['a_restrict']) : null;
        $this->a_restrict_data = isset($data['a_restrict_data']) ? new Purchase56GetResponseLoginPromotionRestrictData((array)$data['a_restrict_data']) : null;
