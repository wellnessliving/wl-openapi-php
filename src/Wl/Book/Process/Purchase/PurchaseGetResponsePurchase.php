...
class PurchaseGetResponsePurchase
{
     ...
     *
     * @var PurchaseGetResponsePurchaseInstallmentTemplate|null
     */
    public ?PurchaseGetResponsePurchaseInstallmentTemplate $a_installment_template = null;

    /**
     * This is only set for Purchase Options. A list of limits on booking by the Purchase Option. Every element has
     * the next keys:
     *
     * @var PurchaseGetResponsePurchaseVisitLimit|null
     */
    public ?PurchaseGetResponsePurchaseVisitLimit $a_visit_limit = null;
    ...
    {
        $this->a_installment_template = isset($data['a_installment_template']) ? new PurchaseGetResponsePurchaseInstallmentTemplate((array)$data['a_installment_template']) : null;
        $this->a_visit_limit = isset($data['a_visit_limit']) ? new PurchaseGetResponsePurchaseVisitLimit((array)$data['a_visit_limit']) : null;
