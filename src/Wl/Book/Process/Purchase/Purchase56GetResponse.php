...
class Purchase56GetResponse
{
     ...
     */
    public ?Purchase56GetResponseLoginPrize $a_login_prize = null;
    ...
    {
        $this->a_login_prize = isset($data['a_login_prize']) ? new Purchase56GetResponseLoginPrize((array)$data['a_login_prize']) : null;
