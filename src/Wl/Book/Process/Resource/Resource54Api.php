...
class Resource54Api
{
     ...
     *
     * @return Resource54ApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): Resource54ApiGetResponse
    {
        return new Resource54ApiGetResponse($this->client->request('/Wl/Book/Process/Resource/Resource54.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return Resource54ApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): Resource54ApiPostResponse
    {
        return new Resource54ApiPostResponse($this->client->request('/Wl/Book/Process/Resource/Resource54.json', $this->params(), 'POST'));
    }
