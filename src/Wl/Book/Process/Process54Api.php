...
class Process54Api
{
     ...
     * @deprecated
     *
     * @return Process54ApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): Process54ApiGetResponse
    {
        return new Process54ApiGetResponse($this->client->request('/Wl/Book/Process/Process54.json', $this->params(), 'GET'));
    }
