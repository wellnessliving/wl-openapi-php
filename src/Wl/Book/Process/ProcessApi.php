...
class ProcessApi
{
     ...
     * @deprecated
     *
     * @return ProcessApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): ProcessApiGetResponse
    {
        return new ProcessApiGetResponse($this->client->request('/Wl/Book/Process/Process.json', $this->params(), 'GET'));
    }
