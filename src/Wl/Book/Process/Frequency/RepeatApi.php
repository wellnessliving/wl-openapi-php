...
class RepeatApi
{
     ...
     *
     * @return RepeatApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): RepeatApiGetResponse
    {
        return new RepeatApiGetResponse($this->client->request('/Wl/Book/Process/Frequency/Repeat.json', $this->params(), 'GET'));
    }
