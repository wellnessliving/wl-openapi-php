...
class InfoPostResponse
{
     ...
     *
     * @var InfoPostResponseVisitPayment[]|null
     */
     ...
     * Their presence will be indicated by the {@link \WlSdk\Wl\Book\Process\Info\InfoPostResponse::$is_next} flag.
     *
     * @var bool|null
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_visit_payment = isset($data['a_visit_payment']) ? array_map(static fn ($item) => new InfoPostResponseVisitPayment((array)$item), (array)$data['a_visit_payment']) : null;
