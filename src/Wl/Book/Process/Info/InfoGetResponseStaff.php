...
class InfoGetResponseStaff
{
    /**
     * The staff member photo:
     *
     * @var InfoGetResponseStaffLogo|null
     */
    public ?InfoGetResponseStaffLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new InfoGetResponseStaffLogo((array)$data['a_logo']) : null;
