...
class InfoApi
{
    ...
    {
        return new InfoApiGetResponse($this->client->request('/Wl/Book/Process/Info/Info.json', $this->params(), 'GET'));
    }
     ...
     * @deprecated
     *
     * @return InfoApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): InfoApiPostResponse
    {
        return new InfoApiPostResponse($this->client->request('/Wl/Book/Process/Info/Info.json', $this->params(), 'POST'));
    }
