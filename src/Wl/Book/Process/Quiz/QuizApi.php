...
class QuizApi
{
     ...
     * `a_quiz`.
     *
     * @return QuizApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): QuizApiGetResponse
    {
        return new QuizApiGetResponse($this->client->request('/Wl/Book/Process/Quiz/Quiz.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return QuizApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): QuizApiPostResponse
    {
        return new QuizApiPostResponse($this->client->request('/Wl/Book/Process/Quiz/Quiz.json', $this->params(), 'POST'));
    }
