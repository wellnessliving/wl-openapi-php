...
class ClassViewGetResponseClass
{
    /**
     * Keys are class key.
     ...
     * Class image data:
     *
     * @var ClassViewGetResponseClassImage|null
     */
    public ?ClassViewGetResponseClassImage $a_image = null;

    /**
     * List of search tags.
     *
     * @var ClassViewGetResponseClassSearchTag|null
     */
    public ?ClassViewGetResponseClassSearchTag $a_search_tag = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_image = isset($data['a_image']) ? new ClassViewGetResponseClassImage((array)$data['a_image']) : null;
        $this->a_search_tag = isset($data['a_search_tag']) ? new ClassViewGetResponseClassSearchTag((array)$data['a_search_tag']) : null;
