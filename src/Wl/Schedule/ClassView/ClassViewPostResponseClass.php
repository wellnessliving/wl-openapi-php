...
class ClassViewPostResponseClass
{
    /**
     * Keys are class key.
     ...
     * Class image data:
     *
     * @var ClassViewPostResponseClassImage|null
     */
    public ?ClassViewPostResponseClassImage $a_image = null;

    /**
     * List of search tags.
     *
     * @var ClassViewPostResponseClassSearchTag|null
     */
    public ?ClassViewPostResponseClassSearchTag $a_search_tag = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_image = isset($data['a_image']) ? new ClassViewPostResponseClassImage((array)$data['a_image']) : null;
        $this->a_search_tag = isset($data['a_search_tag']) ? new ClassViewPostResponseClassSearchTag((array)$data['a_search_tag']) : null;
