...
class ClassViewPostResponseSessionResultStaff
{
    /**
     * Information about staff photo:
     *
     * @var ClassViewPostResponseSessionResultStaffLogo|null
     */
    public ?ClassViewPostResponseSessionResultStaffLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new ClassViewPostResponseSessionResultStaffLogo((array)$data['a_logo']) : null;
