...
class ClassViewGetResponseSessionResultStaff
{
    /**
     * Information about staff photo:
     *
     * @var ClassViewGetResponseSessionResultStaffLogo|null
     */
    public ?ClassViewGetResponseSessionResultStaffLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new ClassViewGetResponseSessionResultStaffLogo((array)$data['a_logo']) : null;
