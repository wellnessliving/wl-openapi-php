...
class ClassViewPostResponseStaff
{
    /**
     * Information about staff photo:
     *
     * @var ClassViewPostResponseStaffLogo|null
     */
    public ?ClassViewPostResponseStaffLogo $a_logo = null;
    ...
    {
        $this->a_logo = isset($data['a_logo']) ? new ClassViewPostResponseStaffLogo((array)$data['a_logo']) : null;
