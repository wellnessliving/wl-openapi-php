...
class PageListApi
{
     ...
     *
     * @return PageListApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): PageListApiGetResponse
    {
        return new PageListApiGetResponse($this->client->request('/Wl/Schedule/Page/PageList.json', $this->params(), 'GET'));
    }
