...
class ScheduleListResourceGetResponseResourceImage
{
    /**
     * Image data.
     *
     * @var ScheduleListResourceGetResponseResourceImageImage|null
     */
    public ?ScheduleListResourceGetResponseResourceImageImage $a_image = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new ScheduleListResourceGetResponseResourceImageImage((array)$data['a_image']) : null;
