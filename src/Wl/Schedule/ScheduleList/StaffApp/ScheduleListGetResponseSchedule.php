...
class ScheduleListGetResponseSchedule
{
     ...
     */
    public ?ScheduleListGetResponseScheduleQuiz $a_quiz = null;

    /**
     * Additional visit information about this appointment. Empty array if it's a class.
     *
     * @var ScheduleListGetResponseScheduleAppointmentVisitInfo|null
     */
    public ?ScheduleListGetResponseScheduleAppointmentVisitInfo $a_appointment_visit_info = null;
     ...
     * @var string[]|null
     */
    public ?array $a_resource_removed = null;
     ...
     */
    public ?ScheduleListGetResponseScheduleStaffInfo $a_staff_info = null;
     ...
     * @var bool|null
     */
    public ?bool $has_quiz_uncompleted = null;
     ...
     * @var bool|null
     */
    public ?bool $show_quiz_icon = null;
     ...
     * @var int|null
     */
    public ?int $t_business_start = null;
     ...
     * @var int|null
     */
    public ?int $t_business_end = null;
     ...
     * @var string|null
     */
    public ?string $text_quiz_title = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_quiz = isset($data['a_quiz']) ? new ScheduleListGetResponseScheduleQuiz((array)$data['a_quiz']) : null;
        $this->a_appointment_visit_info = isset($data['a_appointment_visit_info']) ? new ScheduleListGetResponseScheduleAppointmentVisitInfo((array)$data['a_appointment_visit_info']) : null;
        $this->a_resource = isset($data['a_resource']) ? (array)$data['a_resource'] : null;
        $this->a_resource_removed = isset($data['a_resource_removed']) ? (array)$data['a_resource_removed'] : null;
        ...
        $this->a_staff_info = isset($data['a_staff_info']) ? new ScheduleListGetResponseScheduleStaffInfo((array)$data['a_staff_info']) : null;
        ...
        $this->has_quiz_uncompleted = isset($data['has_quiz_uncompleted']) ? (bool)$data['has_quiz_uncompleted'] : null;
        $this->i_addon = isset($data['i_addon']) ? (int)$data['i_addon'] : null;
        ...
        $this->show_quiz_icon = isset($data['show_quiz_icon']) ? (bool)$data['show_quiz_icon'] : null;
        $this->t_business_start = isset($data['t_business_start']) ? (int)$data['t_business_start'] : null;
        $this->t_business_end = isset($data['t_business_end']) ? (int)$data['t_business_end'] : null;
        ...
        $this->text_quiz_title = isset($data['text_quiz_title']) ? (string)$data['text_quiz_title'] : null;
