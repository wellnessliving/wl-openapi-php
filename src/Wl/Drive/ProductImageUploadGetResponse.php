 ...
 * Response from GET
 */
class ProductImageUploadGetResponse
{
    /**
     * Information about the text for an empty image upload.
     *
     * @var ProductImageUploadGetResponseTextEmpty|null
     */
    public ?ProductImageUploadGetResponseTextEmpty $a_text_empty = null;
    ...
    {
        $this->a_text_empty = isset($data['a_text_empty']) ? new ProductImageUploadGetResponseTextEmpty((array)$data['a_text_empty']) : null;
