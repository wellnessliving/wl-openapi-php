 ...
 * Response from PUT
 */
class ProductImageUploadPutResponse
{
    /**
     * Information about the text for an empty image upload.
     *
     * @var ProductImageUploadPutResponseTextEmpty|null
     */
    public ?ProductImageUploadPutResponseTextEmpty $a_text_empty = null;
    ...
    {
        $this->a_text_empty = isset($data['a_text_empty']) ? new ProductImageUploadPutResponseTextEmpty((array)$data['a_text_empty']) : null;
