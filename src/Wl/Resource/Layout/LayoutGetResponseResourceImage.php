...
class LayoutGetResponseResourceImage
{
    /**
     * Image data.
     *
     * @var LayoutGetResponseResourceImageImage|null
     */
    public ?LayoutGetResponseResourceImageImage $a_image = null;
    ...
    {
        $this->a_image = isset($data['a_image']) ? new LayoutGetResponseResourceImageImage((array)$data['a_image']) : null;
