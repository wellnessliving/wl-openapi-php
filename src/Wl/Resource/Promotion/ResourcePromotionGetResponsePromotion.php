...
class ResourcePromotionGetResponsePromotion
{
    /**
     * Promotion key. Primary key in RsPromotionSql table.
     *
     * @var string|null
     */
    ...
    /**
     * `true` if the promotion is related to the resource, `false` otherwise.
     *
     * @var bool|null
     */
