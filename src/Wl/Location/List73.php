...
class List73
{
     ...
     *
     * @return List73GetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(List73GetRequest $request): List73GetResponse
    {
        return new List73GetResponse($this->client->request('/Wl/Location/List73.json', $request->params(), 'GET'));
    }
}
