...
class ListBulkGetResponseLocationFull
{
    /**
     ...
     *
     * @var ListBulkGetResponseLocationFullLogo|null
     */
    public ?ListBulkGetResponseLocationFullLogo $a_logo = null;

    /**
     * A list of the location images.
     * Every element has the following keys:
     *
     * @var ListBulkGetResponseLocationFullSlide|null
     */
    public ?ListBulkGetResponseLocationFullSlide $a_slide = null;
     ...
     * fields:
     *
     * @var ListBulkGetResponseLocationFullWork|null
     */
    public ?ListBulkGetResponseLocationFullWork $a_work = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->a_logo = isset($data['a_logo']) ? new ListBulkGetResponseLocationFullLogo((array)$data['a_logo']) : null;
        $this->a_slide = isset($data['a_slide']) ? new ListBulkGetResponseLocationFullSlide((array)$data['a_slide']) : null;
        $this->a_work = isset($data['a_work']) ? new ListBulkGetResponseLocationFullWork((array)$data['a_work']) : null;
        $this->dtu_check = isset($data['dtu_check']) ? (string)$data['dtu_check'] : null;
