...
class QuizElement72GetResponseElementDAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementDAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementDAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementDAmendmentChange((array)$data['a_change']) : null;
