...
class QuizElementGetResponseElementGAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementGAmendmentChange|null
     */
    public ?QuizElementGetResponseElementGAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementGAmendmentChange((array)$data['a_change']) : null;
