...
class QuizElementGetResponseElementEAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementEAmendmentChange|null
     */
    public ?QuizElementGetResponseElementEAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementEAmendmentChange((array)$data['a_change']) : null;
