...
class QuizElement72GetResponseElementH
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementHAmendment|null
     */
    public ?QuizElement72GetResponseElementHAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementHAmendment((array)$data['a_amendment']) : null;
