...
class QuizElementGetResponseElementA
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementAAmendment|null
     */
    public ?QuizElementGetResponseElementAAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementAAmendment((array)$data['a_amendment']) : null;
