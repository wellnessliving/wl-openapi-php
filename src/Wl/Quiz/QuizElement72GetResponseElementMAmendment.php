...
class QuizElement72GetResponseElementMAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementMAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementMAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementMAmendmentChange((array)$data['a_change']) : null;
