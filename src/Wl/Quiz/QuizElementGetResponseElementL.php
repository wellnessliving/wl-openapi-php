...
class QuizElementGetResponseElementL
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementLAmendment|null
     */
    public ?QuizElementGetResponseElementLAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementLAmendment((array)$data['a_amendment']) : null;
