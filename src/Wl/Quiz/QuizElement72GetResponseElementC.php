...
class QuizElement72GetResponseElementC
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementCAmendment|null
     */
    public ?QuizElement72GetResponseElementCAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementCAmendment((array)$data['a_amendment']) : null;
