...
class QuizElement72GetResponseElementE
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementEAmendment|null
     */
    public ?QuizElement72GetResponseElementEAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementEAmendment((array)$data['a_amendment']) : null;
