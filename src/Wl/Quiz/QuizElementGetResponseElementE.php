...
class QuizElementGetResponseElementE
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementEAmendment|null
     */
    public ?QuizElementGetResponseElementEAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementEAmendment((array)$data['a_amendment']) : null;
