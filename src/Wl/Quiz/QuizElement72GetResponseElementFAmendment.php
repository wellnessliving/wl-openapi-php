...
class QuizElement72GetResponseElementFAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementFAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementFAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementFAmendmentChange((array)$data['a_change']) : null;
