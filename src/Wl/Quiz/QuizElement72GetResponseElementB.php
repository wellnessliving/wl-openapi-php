...
class QuizElement72GetResponseElementB
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementBAmendment|null
     */
    public ?QuizElement72GetResponseElementBAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementBAmendment((array)$data['a_amendment']) : null;
