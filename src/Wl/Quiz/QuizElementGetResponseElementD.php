...
class QuizElementGetResponseElementD
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementDAmendment|null
     */
    public ?QuizElementGetResponseElementDAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementDAmendment((array)$data['a_amendment']) : null;
