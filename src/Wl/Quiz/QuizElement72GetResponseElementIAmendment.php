...
class QuizElement72GetResponseElementIAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementIAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementIAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementIAmendmentChange((array)$data['a_change']) : null;
