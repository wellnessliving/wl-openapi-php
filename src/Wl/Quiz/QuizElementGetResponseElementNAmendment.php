...
class QuizElementGetResponseElementNAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementNAmendmentChange|null
     */
    public ?QuizElementGetResponseElementNAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementNAmendmentChange((array)$data['a_change']) : null;
