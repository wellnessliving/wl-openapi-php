...
class QuizElement72GetResponseElementCAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementCAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementCAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementCAmendmentChange((array)$data['a_change']) : null;
