...
class QuizElement72GetResponseElementN
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementNAmendment|null
     */
    public ?QuizElement72GetResponseElementNAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementNAmendment((array)$data['a_amendment']) : null;
