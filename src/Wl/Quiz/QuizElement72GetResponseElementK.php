...
class QuizElement72GetResponseElementK
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementKAmendment|null
     */
    public ?QuizElement72GetResponseElementKAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementKAmendment((array)$data['a_amendment']) : null;
