...
class QuizElementGetResponseElementBAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementBAmendmentChange|null
     */
    public ?QuizElementGetResponseElementBAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementBAmendmentChange((array)$data['a_change']) : null;
