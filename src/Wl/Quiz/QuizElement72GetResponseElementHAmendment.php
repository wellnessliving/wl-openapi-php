...
class QuizElement72GetResponseElementHAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementHAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementHAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementHAmendmentChange((array)$data['a_change']) : null;
