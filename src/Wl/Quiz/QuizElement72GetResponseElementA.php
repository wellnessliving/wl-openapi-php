...
class QuizElement72GetResponseElementA
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementAAmendment|null
     */
    public ?QuizElement72GetResponseElementAAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementAAmendment((array)$data['a_amendment']) : null;
