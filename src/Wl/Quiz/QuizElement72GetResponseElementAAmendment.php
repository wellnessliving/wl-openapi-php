...
class QuizElement72GetResponseElementAAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementAAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementAAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementAAmendmentChange((array)$data['a_change']) : null;
