...
class QuizElement72GetResponseElementL
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementLAmendment|null
     */
    public ?QuizElement72GetResponseElementLAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementLAmendment((array)$data['a_amendment']) : null;
