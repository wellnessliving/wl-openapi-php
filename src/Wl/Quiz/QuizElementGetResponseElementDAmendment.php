...
class QuizElementGetResponseElementDAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementDAmendmentChange|null
     */
    public ?QuizElementGetResponseElementDAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementDAmendmentChange((array)$data['a_change']) : null;
