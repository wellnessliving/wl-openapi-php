...
class QuizElementGetResponseElementI
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementIAmendment|null
     */
    public ?QuizElementGetResponseElementIAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementIAmendment((array)$data['a_amendment']) : null;
