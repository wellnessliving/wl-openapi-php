...
class QuizElementGetResponseElementFAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementFAmendmentChange|null
     */
    public ?QuizElementGetResponseElementFAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementFAmendmentChange((array)$data['a_change']) : null;
