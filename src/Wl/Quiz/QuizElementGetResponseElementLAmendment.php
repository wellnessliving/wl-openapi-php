...
class QuizElementGetResponseElementLAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementLAmendmentChange|null
     */
    public ?QuizElementGetResponseElementLAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementLAmendmentChange((array)$data['a_change']) : null;
