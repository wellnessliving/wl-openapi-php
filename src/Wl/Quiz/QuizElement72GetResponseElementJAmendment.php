...
class QuizElement72GetResponseElementJAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementJAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementJAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementJAmendmentChange((array)$data['a_change']) : null;
