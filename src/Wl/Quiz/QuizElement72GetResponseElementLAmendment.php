...
class QuizElement72GetResponseElementLAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementLAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementLAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementLAmendmentChange((array)$data['a_change']) : null;
