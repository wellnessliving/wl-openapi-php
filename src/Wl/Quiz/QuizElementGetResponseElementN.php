...
class QuizElementGetResponseElementN
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElementGetResponseElementNAmendment|null
     */
    public ?QuizElementGetResponseElementNAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElementGetResponseElementNAmendment((array)$data['a_amendment']) : null;
