...
class QuizElement72GetResponseElementGAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementGAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementGAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementGAmendmentChange((array)$data['a_change']) : null;
