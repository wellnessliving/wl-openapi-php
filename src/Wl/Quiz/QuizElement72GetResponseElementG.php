...
class QuizElement72GetResponseElementG
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementGAmendment|null
     */
    public ?QuizElement72GetResponseElementGAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementGAmendment((array)$data['a_amendment']) : null;
