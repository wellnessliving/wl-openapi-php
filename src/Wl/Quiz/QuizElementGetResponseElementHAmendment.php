...
class QuizElementGetResponseElementHAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementHAmendmentChange|null
     */
    public ?QuizElementGetResponseElementHAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementHAmendmentChange((array)$data['a_change']) : null;
