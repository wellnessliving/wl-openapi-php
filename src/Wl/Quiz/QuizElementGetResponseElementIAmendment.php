...
class QuizElementGetResponseElementIAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementIAmendmentChange|null
     */
    public ?QuizElementGetResponseElementIAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementIAmendmentChange((array)$data['a_change']) : null;
