...
class QuizElementGetResponseElementMAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElementGetResponseElementMAmendmentChange|null
     */
    public ?QuizElementGetResponseElementMAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElementGetResponseElementMAmendmentChange((array)$data['a_change']) : null;
