...
class QuizElement72GetResponseElementKAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementKAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementKAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementKAmendmentChange((array)$data['a_change']) : null;
