...
class QuizElement72GetResponseElementF
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementFAmendment|null
     */
    public ?QuizElement72GetResponseElementFAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementFAmendment((array)$data['a_amendment']) : null;
