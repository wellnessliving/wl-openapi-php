...
class QuizElement72GetResponseElementEAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementEAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementEAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementEAmendmentChange((array)$data['a_change']) : null;
