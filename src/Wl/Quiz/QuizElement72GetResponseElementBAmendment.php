...
class QuizElement72GetResponseElementBAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementBAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementBAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementBAmendmentChange((array)$data['a_change']) : null;
