...
class ResponseGetResponseElementI
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementIAmendment|null
     */
    public ?ResponseGetResponseElementIAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementIAmendment((array)$data['a_amendment']) : null;
