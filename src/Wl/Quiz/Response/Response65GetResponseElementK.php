...
class Response65GetResponseElementK
{
     ...
     *
     * @var Response65GetResponseElementKAmendment|null
     */
    public ?Response65GetResponseElementKAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementKAmendment((array)$data['a_amendment']) : null;
