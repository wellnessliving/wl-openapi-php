...
class ResponseGetResponseElementF
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementFAmendment|null
     */
    public ?ResponseGetResponseElementFAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementFAmendment((array)$data['a_amendment']) : null;
