...
class ResponseGetResponseElementEAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementEAmendmentChange|null
     */
    public ?ResponseGetResponseElementEAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementEAmendmentChange((array)$data['a_change']) : null;
