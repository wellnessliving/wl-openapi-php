...
class Response65GetResponseElementH
{
     ...
     *
     * @var Response65GetResponseElementHAmendment|null
     */
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementHAmendment((array)$data['a_amendment']) : null;
