...
class Response65GetResponseElementN
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementNAmendment|null
     */
    public ?Response65GetResponseElementNAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementNAmendment((array)$data['a_amendment']) : null;
