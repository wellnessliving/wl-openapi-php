...
class ResponseGetResponseElementDAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementDAmendmentChange|null
     */
    public ?ResponseGetResponseElementDAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementDAmendmentChange((array)$data['a_change']) : null;
