...
class Response65GetResponseElementIAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementIAmendmentChange|null
     */
    public ?Response65GetResponseElementIAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementIAmendmentChange((array)$data['a_change']) : null;
