...
class ResponseGetResponseElementCAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementCAmendmentChange|null
     */
    public ?ResponseGetResponseElementCAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementCAmendmentChange((array)$data['a_change']) : null;
