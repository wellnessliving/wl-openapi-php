...
class ResponseGetResponseElementG
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementGAmendment|null
     */
    public ?ResponseGetResponseElementGAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementGAmendment((array)$data['a_amendment']) : null;
