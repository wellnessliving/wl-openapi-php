...
class Response65GetResponseElementJ
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementJAmendment|null
     */
    public ?Response65GetResponseElementJAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementJAmendment((array)$data['a_amendment']) : null;
