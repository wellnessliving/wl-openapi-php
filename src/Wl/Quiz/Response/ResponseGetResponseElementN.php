...
class ResponseGetResponseElementN
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementNAmendment|null
     */
    public ?ResponseGetResponseElementNAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementNAmendment((array)$data['a_amendment']) : null;
