...
class ResponseGetResponseElementH
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementHAmendment|null
     */
    public ?ResponseGetResponseElementHAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementHAmendment((array)$data['a_amendment']) : null;
