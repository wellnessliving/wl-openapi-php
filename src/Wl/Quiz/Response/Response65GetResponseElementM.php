...
class Response65GetResponseElementM
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementMAmendment|null
     */
    public ?Response65GetResponseElementMAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementMAmendment((array)$data['a_amendment']) : null;
