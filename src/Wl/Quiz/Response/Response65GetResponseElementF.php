...
class Response65GetResponseElementF
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementFAmendment|null
     */
    public ?Response65GetResponseElementFAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementFAmendment((array)$data['a_amendment']) : null;
