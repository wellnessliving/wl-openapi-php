...
class ResponseGetResponseElementB
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementBAmendment|null
     */
    public ?ResponseGetResponseElementBAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementBAmendment((array)$data['a_amendment']) : null;
