...
class ResponseGetResponseElementMAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementMAmendmentChange|null
     */
    public ?ResponseGetResponseElementMAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementMAmendmentChange((array)$data['a_change']) : null;
