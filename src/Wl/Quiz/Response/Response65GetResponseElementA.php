...
class Response65GetResponseElementA
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementAAmendment|null
     */
    public ?Response65GetResponseElementAAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementAAmendment((array)$data['a_amendment']) : null;
