...
class ResponseGetResponseElementD
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementDAmendment|null
     */
    public ?ResponseGetResponseElementDAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementDAmendment((array)$data['a_amendment']) : null;
