...
class ResponseGetResponseElementIAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementIAmendmentChange|null
     */
    public ?ResponseGetResponseElementIAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementIAmendmentChange((array)$data['a_change']) : null;
