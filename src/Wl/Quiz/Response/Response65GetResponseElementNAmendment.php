...
class Response65GetResponseElementNAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementNAmendmentChange|null
     */
    public ?Response65GetResponseElementNAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementNAmendmentChange((array)$data['a_change']) : null;
