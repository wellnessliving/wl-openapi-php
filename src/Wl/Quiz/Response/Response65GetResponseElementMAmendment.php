...
class Response65GetResponseElementMAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementMAmendmentChange|null
     */
    public ?Response65GetResponseElementMAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementMAmendmentChange((array)$data['a_change']) : null;
