...
class ResponseGetResponseElementKAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementKAmendmentChange|null
     */
    public ?ResponseGetResponseElementKAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementKAmendmentChange((array)$data['a_change']) : null;
