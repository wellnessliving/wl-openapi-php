...
class Response65GetResponseElementHAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementHAmendmentChange|null
     */
    public ?Response65GetResponseElementHAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementHAmendmentChange((array)$data['a_change']) : null;
