...
class Response65GetResponseElementI
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementIAmendment|null
     */
    public ?Response65GetResponseElementIAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementIAmendment((array)$data['a_amendment']) : null;
