...
class ResponseGetResponseElementJAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementJAmendmentChange|null
     */
    public ?ResponseGetResponseElementJAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementJAmendmentChange((array)$data['a_change']) : null;
