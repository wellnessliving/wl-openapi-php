...
class ResponseGetResponseElementJ
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementJAmendment|null
     */
    public ?ResponseGetResponseElementJAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementJAmendment((array)$data['a_amendment']) : null;
