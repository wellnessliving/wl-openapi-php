...
class ResponseGetResponseElementBAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementBAmendmentChange|null
     */
    public ?ResponseGetResponseElementBAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementBAmendmentChange((array)$data['a_change']) : null;
