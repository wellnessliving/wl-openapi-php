...
class ResponseGetResponseElementHAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementHAmendmentChange|null
     */
    public ?ResponseGetResponseElementHAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementHAmendmentChange((array)$data['a_change']) : null;
