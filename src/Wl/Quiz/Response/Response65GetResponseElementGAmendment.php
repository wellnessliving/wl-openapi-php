...
class Response65GetResponseElementGAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementGAmendmentChange|null
     */
    public ?Response65GetResponseElementGAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementGAmendmentChange((array)$data['a_change']) : null;
