...
class ResponseGetResponseElementE
{
     ...
     *
     * @var ResponseGetResponseElementEAmendment|null
     */
    public ?ResponseGetResponseElementEAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementEAmendment((array)$data['a_amendment']) : null;
