...
class ResponseGetResponseElementK
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementKAmendment|null
     */
    public ?ResponseGetResponseElementKAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementKAmendment((array)$data['a_amendment']) : null;
