...
class ResponseGetResponseElementLAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementLAmendmentChange|null
     */
    public ?ResponseGetResponseElementLAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementLAmendmentChange((array)$data['a_change']) : null;
