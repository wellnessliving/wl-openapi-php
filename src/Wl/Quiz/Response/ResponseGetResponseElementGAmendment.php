...
class ResponseGetResponseElementGAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementGAmendmentChange|null
     */
    public ?ResponseGetResponseElementGAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementGAmendmentChange((array)$data['a_change']) : null;
