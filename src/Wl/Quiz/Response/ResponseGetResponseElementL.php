...
class ResponseGetResponseElementL
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementLAmendment|null
     */
    public ?ResponseGetResponseElementLAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementLAmendment((array)$data['a_amendment']) : null;
