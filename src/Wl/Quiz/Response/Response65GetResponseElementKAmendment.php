...
class Response65GetResponseElementKAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementKAmendmentChange|null
     */
    public ?Response65GetResponseElementKAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementKAmendmentChange((array)$data['a_change']) : null;
