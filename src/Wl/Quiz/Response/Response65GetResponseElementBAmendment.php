...
class Response65GetResponseElementBAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementBAmendmentChange|null
     */
    public ?Response65GetResponseElementBAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementBAmendmentChange((array)$data['a_change']) : null;
