...
class Response65GetResponseElementEAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementEAmendmentChange|null
     */
    public ?Response65GetResponseElementEAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementEAmendmentChange((array)$data['a_change']) : null;
