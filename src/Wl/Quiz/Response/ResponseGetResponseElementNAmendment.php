...
class ResponseGetResponseElementNAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementNAmendmentChange|null
     */
    public ?ResponseGetResponseElementNAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementNAmendmentChange((array)$data['a_change']) : null;
