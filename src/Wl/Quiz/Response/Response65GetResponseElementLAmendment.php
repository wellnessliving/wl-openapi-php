...
class Response65GetResponseElementLAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementLAmendmentChange|null
     */
    public ?Response65GetResponseElementLAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementLAmendmentChange((array)$data['a_change']) : null;
