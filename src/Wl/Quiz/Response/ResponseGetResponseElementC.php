...
class ResponseGetResponseElementC
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementCAmendment|null
     */
    public ?ResponseGetResponseElementCAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementCAmendment((array)$data['a_amendment']) : null;
