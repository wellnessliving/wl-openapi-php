...
class Response65GetResponseElementDAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementDAmendmentChange|null
     */
    public ?Response65GetResponseElementDAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementDAmendmentChange((array)$data['a_change']) : null;
