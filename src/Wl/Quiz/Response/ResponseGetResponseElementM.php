...
class ResponseGetResponseElementM
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var ResponseGetResponseElementMAmendment|null
     */
    public ?ResponseGetResponseElementMAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new ResponseGetResponseElementMAmendment((array)$data['a_amendment']) : null;
