...
class Response65GetResponseElementB
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementBAmendment|null
     */
    public ?Response65GetResponseElementBAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementBAmendment((array)$data['a_amendment']) : null;
