...
class ResponseGetResponseElementAAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementAAmendmentChange|null
     */
    public ?ResponseGetResponseElementAAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementAAmendmentChange((array)$data['a_change']) : null;
