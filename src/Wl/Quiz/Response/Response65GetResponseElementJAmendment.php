...
class Response65GetResponseElementJAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementJAmendmentChange|null
     */
    public ?Response65GetResponseElementJAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementJAmendmentChange((array)$data['a_change']) : null;
