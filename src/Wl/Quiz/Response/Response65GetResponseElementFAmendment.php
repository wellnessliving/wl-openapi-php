...
class Response65GetResponseElementFAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementFAmendmentChange|null
     */
    public ?Response65GetResponseElementFAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementFAmendmentChange((array)$data['a_change']) : null;
