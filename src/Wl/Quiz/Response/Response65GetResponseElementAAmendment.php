...
class Response65GetResponseElementAAmendment
{
    /**
     * Information about amend.
     *
     * @var Response65GetResponseElementAAmendmentChange|null
     */
    public ?Response65GetResponseElementAAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new Response65GetResponseElementAAmendmentChange((array)$data['a_change']) : null;
