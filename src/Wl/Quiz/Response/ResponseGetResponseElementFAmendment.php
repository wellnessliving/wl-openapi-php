...
class ResponseGetResponseElementFAmendment
{
    /**
     * Information about amend.
     *
     * @var ResponseGetResponseElementFAmendmentChange|null
     */
    public ?ResponseGetResponseElementFAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new ResponseGetResponseElementFAmendmentChange((array)$data['a_change']) : null;
