...
class Response65GetResponseElementL
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementLAmendment|null
     */
    public ?Response65GetResponseElementLAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementLAmendment((array)$data['a_amendment']) : null;
