...
class Response65GetResponseElementG
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementGAmendment|null
     */
    public ?Response65GetResponseElementGAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementGAmendment((array)$data['a_amendment']) : null;
