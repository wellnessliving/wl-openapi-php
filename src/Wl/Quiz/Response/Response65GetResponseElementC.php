...
class Response65GetResponseElementC
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementCAmendment|null
     */
    public ?Response65GetResponseElementCAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementCAmendment((array)$data['a_amendment']) : null;
