...
class Response65GetResponseElementD
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var Response65GetResponseElementDAmendment|null
     */
    public ?Response65GetResponseElementDAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new Response65GetResponseElementDAmendment((array)$data['a_amendment']) : null;
