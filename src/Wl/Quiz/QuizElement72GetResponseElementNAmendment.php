...
class QuizElement72GetResponseElementNAmendment
{
    /**
     * Information about amend.
     *
     * @var QuizElement72GetResponseElementNAmendmentChange|null
     */
    public ?QuizElement72GetResponseElementNAmendmentChange $a_change = null;
    ...
    {
        $this->a_change = isset($data['a_change']) ? new QuizElement72GetResponseElementNAmendmentChange((array)$data['a_change']) : null;
