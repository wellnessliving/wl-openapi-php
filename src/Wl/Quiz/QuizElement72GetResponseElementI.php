...
class QuizElement72GetResponseElementI
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementIAmendment|null
     */
    public ?QuizElement72GetResponseElementIAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementIAmendment((array)$data['a_amendment']) : null;
