...
class QuizElement72GetResponseElementJ
{
    /**
     * List of amendments.
     * Each element has next structure:
     *
     * @var QuizElement72GetResponseElementJAmendment|null
     */
    public ?QuizElement72GetResponseElementJAmendment $a_amendment = null;
    ...
    {
        $this->a_amendment = isset($data['a_amendment']) ? new QuizElement72GetResponseElementJAmendment((array)$data['a_amendment']) : null;
