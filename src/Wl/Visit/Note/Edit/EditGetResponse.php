...
class EditGetResponse
{
     ...
     *
     * @var EditGetResponseDataNoteAdditional[]|null
     */
     ...
     *
     * @var EditGetResponseInfo|null
     */
    public ?EditGetResponseInfo $a_info = null;
    ...
    {
        $this->a_data_note_additional = isset($data['a_data_note_additional']) ? array_map(static fn ($item) => new EditGetResponseDataNoteAdditional((array)$item), (array)$data['a_data_note_additional']) : null;
        $this->a_info = isset($data['a_info']) ? new EditGetResponseInfo((array)$data['a_info']) : null;
