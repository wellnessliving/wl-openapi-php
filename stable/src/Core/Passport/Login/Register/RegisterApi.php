...
class RegisterApi
{
     ...
     *
     * @return RegisterApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): RegisterApiPostResponse
    {
        return new RegisterApiPostResponse($this->client->request('/Core/Passport/Login/Register/Register.json', $this->params(), 'POST'));
    }
