...
<ul>
  ...
  <li>`&#039;password&#039;` Remember user login and password.</li>
     ...
     *   - string url_redirect: An optional URL for redirection after the user has signed in to the web application.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): array
    {
        return $this->client->request('/Core/Passport/Login/Enter/Enter.json', $this->params(), 'POST');
    }
