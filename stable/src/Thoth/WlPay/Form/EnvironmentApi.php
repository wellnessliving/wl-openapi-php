...
and values are IDs of card systems (one of [ACardSystemSid](#/components/schemas/ACardSystemSid) constants).
     *   - int[] a_method_staff: A list of payment methods enabled for staff members. The ID is one of [RsPayMethodSid](#/components/schemas/RsPayMethodSid) constants.
...
This will be `null` if the fixed surcharge amount shouldn't be withdrawn.
    ...
    {
        return $this->client->request('/Thoth/WlPay/Form/Environment.json', $this->params(), 'GET');
    }
