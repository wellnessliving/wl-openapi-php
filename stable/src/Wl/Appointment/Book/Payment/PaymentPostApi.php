...
Values are quiz response keys.
    ...
    {
        return $this->client->request('/Wl/Appointment/Book/Payment/PaymentPost.json', $this->params(), 'GET');
    }
...
Empty if no purchase has been made.
    ...
    {
        return $this->client->request('/Wl/Appointment/Book/Payment/PaymentPost.json', $this->params(), 'POST');
    }
