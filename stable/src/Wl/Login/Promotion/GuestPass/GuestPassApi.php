...
Only standard 4xx codes are accepted.
     ...
     *   - array[] a_guest_pass: No description.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): array
    {
        return $this->client->request('/Wl/Login/Promotion/GuestPass/GuestPass.json', $this->params(), 'GET');
    }
    ...
    {
        return $this->client->request('/Wl/Login/Promotion/GuestPass/GuestPass.json', $this->params(), 'PUT');
    }
