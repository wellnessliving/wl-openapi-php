...
Only standard 4xx codes are accepted.
     ...
     *   - string s_member: The user's ID to get/set.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): array
    {
        return $this->client->request('/Wl/Login/Member/LoginMember.json', $this->params(), 'GET');
    }
     ...
     *
     * @return array Parsed JSON response data.
     *   - string dt_member: The date when client became a member.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): array
    {
        return $this->client->request('/Wl/Login/Member/LoginMember.json', $this->params(), 'POST');
    }
