...
Only standard 4xx codes are accepted.
     ...
     *   - string k_visit: The visit key.
     *   - string text_message: The status message displayed on a successful check-in.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): array
    {
        return $this->client->request('/Wl/Reception/Roster/AttendanceListAttend.json', $this->params(), 'POST');
    }
