 ...
 * Response from GET
 */
class PurchaseReceiptApiGetResponse
{
    /**
     * No description.
     *
    ...
    {
        $this->a_account_rest = isset($data['a_account_rest']) ? (array)$data['a_account_rest'] : null;
        $this->a_business = isset($data['a_business']) ? (array)$data['a_business'] : null;
        $this->a_card = isset($data['a_card']) ? (array)$data['a_card'] : null;
        $this->a_customer = isset($data['a_customer']) ? (array)$data['a_customer'] : null;
        $this->a_pay_method = isset($data['a_pay_method']) ? (array)$data['a_pay_method'] : null;
        $this->a_price = isset($data['a_price']) ? (array)$data['a_price'] : null;
