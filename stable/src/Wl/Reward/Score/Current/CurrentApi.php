...
Only standard 4xx codes are accepted.
     ...
     *   - int i_board_rank: Current user's rank in the first leaderboard.
     *   - int i_score: Current score in wellnessliving points.
     *   - string s_board_title: Title of the first leaderboard.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): array
    {
        return $this->client->request('/Wl/Reward/Score/Current/Current.json', $this->params(), 'GET');
    }
