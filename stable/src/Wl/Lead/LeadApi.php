...
class LeadApi
{
     ...
     *
     * @return LeadApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): LeadApiGetResponse
    {
        return new LeadApiGetResponse($this->client->request('/Wl/Lead/Lead.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return LeadApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): LeadApiPostResponse
    {
        return new LeadApiPostResponse($this->client->request('/Wl/Lead/Lead.json', $this->params(), 'POST'));
    }
