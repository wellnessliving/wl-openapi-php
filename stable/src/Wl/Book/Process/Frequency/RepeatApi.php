...
should be ignored. Example: ['70::2024-11-05 18:00:00'].
    ...
    /**
     * Date to start recurring booking. Not empty only when `id_repeat_end` == [RsRepeatEndSid::DATE](#/components/schemas/RsRepeatEndSid).
     *
     * @var string|null
     */
    ...
    /**
     * Date to finish recurring booking. Not empty only when `id_repeat_end` == [RsRepeatEndSid::DATE](#/components/schemas/RsRepeatEndSid).
     *
     * @var string|null
     */
    ...
    /**
     * Count of the visits to be created. Not empty only when `id_repeat_end` == [RsRepeatEndSid::COUNT](#/components/schemas/RsRepeatEndSid).
     *
     * @var int|null
     */
     ...
     *   - string dt_from: Date to start recurring booking. Not empty only when `id_repeat_end` == [RsRepeatEndSid::DATE](#/components/schemas/RsRepeatEndSid).
     *   - string dt_to: Date to finish recurring booking. Not empty only when `id_repeat_end` == [RsRepeatEndSid::DATE](#/components/schemas/RsRepeatEndSid).
     *   - int i_count: Count of the visits to be created. Not empty only when `id_repeat_end` == [RsRepeatEndSid::COUNT](#/components/schemas/RsRepeatEndSid).
    ...
    {
        return $this->client->request('/Wl/Book/Process/Frequency/Repeat.json', $this->params(), 'GET');
    }
