...
class EditByTokenApi
{
     ...
     *
     * @return EditByTokenApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): EditByTokenApiGetResponse
    {
        return new EditByTokenApiGetResponse($this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'GET'));
    }
     ...
     *
     * @return EditByTokenApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): EditByTokenApiPostResponse
    {
        return new EditByTokenApiPostResponse($this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'POST'));
    }
     ...
     *
     * @return EditByTokenApiPutResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function put(): EditByTokenApiPutResponse
    {
        return new EditByTokenApiPutResponse($this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'PUT'));
    }
