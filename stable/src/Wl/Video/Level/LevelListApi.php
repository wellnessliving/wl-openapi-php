...
Only standard 4xx codes are accepted.
     ...
     *   - array[] a_level_list: No description.
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): array
    {
        return $this->client->request('/Wl/Video/Level/LevelList.json', $this->params(), 'GET');
    }
    ...
    {
        return $this->client->request('/Wl/Video/Level/LevelList.json', $this->params(), 'PUT');
    }
