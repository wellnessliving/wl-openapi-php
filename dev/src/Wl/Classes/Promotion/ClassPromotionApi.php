...
class ClassPromotionApi
{
     ...
     *
     * @return ClassPromotionApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): ClassPromotionApiGetResponse
    {
        return new ClassPromotionApiGetResponse($this->client->request('/Wl/Classes/Promotion/ClassPromotion.json', $this->params(), 'GET'));
    }
