...
`false` if user pressed 'Pay now'.
    ...
    {
        return $this->client->request('/Wl/Book/Process/Resource/Resource54.json', $this->params(), 'GET');
    }
...
`false` - no further booking steps are required.
    ...
    {
        return $this->client->request('/Wl/Book/Process/Resource/Resource54.json', $this->params(), 'POST');
    }
