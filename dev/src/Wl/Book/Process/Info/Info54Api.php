...
List of staff see [InfoApi](/Wl/Book/Process/Info/Info.json).
    ...
    {
        return $this->client->request('/Wl/Book/Process/Info/Info54.json', $this->params(), 'GET');
    }
...
`false` - no need for next steps (all that's needed has already been purchased).
    ...
    {
        return $this->client->request('/Wl/Book/Process/Info/Info54.json', $this->params(), 'POST');
    }
