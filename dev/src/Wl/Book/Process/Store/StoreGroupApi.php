...
class StoreGroupApi
{
     ...
     *
     * @return StoreGroupApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): StoreGroupApiPostResponse
    {
        return new StoreGroupApiPostResponse($this->client->request('/Wl/Book/Process/Store/StoreGroup.json', $this->params(), 'POST'));
    }
