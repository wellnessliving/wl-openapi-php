...
class BusinessAccessApi
{
     ...
     * are also evaluated.
     *
     * @return BusinessAccessApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): BusinessAccessApiGetResponse
    {
        return new BusinessAccessApiGetResponse($this->client->request('/Wl/Business/BusinessAccess.json', $this->params(), 'GET'));
    }
