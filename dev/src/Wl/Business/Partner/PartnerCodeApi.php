...
Only standard 4xx codes are accepted.
     ...
     *   - string url_partner: Link to the landing campaign
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): array
    {
        return $this->client->request('/Wl/Business/Partner/PartnerCode.json', $this->params(), 'GET');
    }
    ...
    {
        return $this->client->request('/Wl/Business/Partner/PartnerCode.json', $this->params(), 'POST');
    }
