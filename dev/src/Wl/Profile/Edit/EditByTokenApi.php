...
`null` If the address is not inherited.
    ...
    {
        return $this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'GET');
    }
...
If empty, an empty form will be displayed to add a new user.
    ...
    {
        return $this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'POST');
    }
    ...
    {
        return $this->client->request('/Wl/Profile/Edit/EditByToken.json', $this->params(), 'PUT');
    }
