...
class PurchaseListElementApi
{
     ...
     *
     * @return PurchaseListElementApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): PurchaseListElementApiGetResponse
    {
        return new PurchaseListElementApiGetResponse($this->client->request('/Wl/Profile/PurchaseList/PurchaseListElement.json', $this->params(), 'GET'));
    }
