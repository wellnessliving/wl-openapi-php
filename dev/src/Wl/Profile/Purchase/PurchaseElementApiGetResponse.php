 ...
 * Response from GET
 */
class PurchaseElementApiGetResponse
{
    /**
     * No description.
     *
    ...
    /**
     * The percentage value of the discount given by a reward prize. This field will be `0` if a discount wasn't
     * applied.
     *
     * @var int|null
     */
    ...
    /**
     * If `true`, then this promotion will be converted to a different promotion after it expires. It `false`, then
     * the
    ...
    /**
     * If `true`, then the usage of this purchased item is disabled. If `false`, then the usage of this purchased
     * item
     * is enabled.
     *
     * @var bool|null
    ...
    /**
     * If `true`, then the discount was applied for the member type. If `false`, then the discount was applied for
     * the
    ...
    /**
     * This is `true` if the gift card has been redeemed. This can only be true if the purchased item is a gift
     * card.
     * Otherwise, this will be `false`.
     *
     * @var bool|null
    ...
    public function __construct(array $data)
    {
        ...
        $this->dt_send = isset($data['dt_send']) ? (string)$data['dt_send'] : null;
