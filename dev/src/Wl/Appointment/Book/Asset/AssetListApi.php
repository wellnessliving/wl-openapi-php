...
class AssetListApi
{
     ...
     *
     * @return AssetListApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): AssetListApiGetResponse
    {
        return new AssetListApiGetResponse($this->client->request('/Wl/Appointment/Book/Asset/AssetList.json', $this->params(), 'GET'));
    }
