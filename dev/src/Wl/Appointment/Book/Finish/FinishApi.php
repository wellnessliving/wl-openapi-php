...
class FinishApi
{
     ...
     * @deprecated
     *
     * @return FinishApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): FinishApiGetResponse
    {
        return new FinishApiGetResponse($this->client->request('/Wl/Appointment/Book/Finish/Finish.json', $this->params(), 'GET'));
    }
     ...
     * @deprecated
     *
     * @return FinishApiPostResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function post(): FinishApiPostResponse
    {
        return new FinishApiPostResponse($this->client->request('/Wl/Appointment/Book/Finish/Finish.json', $this->params(), 'POST'));
    }
