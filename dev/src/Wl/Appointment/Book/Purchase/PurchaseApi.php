...
class PurchaseApi
{
     ...
     * @deprecated
     *
     * @return PurchaseApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): PurchaseApiGetResponse
    {
        return new PurchaseApiGetResponse($this->client->request('/Wl/Appointment/Book/Purchase/Purchase.json', $this->params(), 'GET'));
    }
