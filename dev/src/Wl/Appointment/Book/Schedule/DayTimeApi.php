...
class DayTimeApi
{
     ...
     * @deprecated
     *
     * @return DayTimeApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): DayTimeApiGetResponse
    {
        return new DayTimeApiGetResponse($this->client->request('/Wl/Appointment/Book/Schedule/DayTime.json', $this->params(), 'GET'));
    }
