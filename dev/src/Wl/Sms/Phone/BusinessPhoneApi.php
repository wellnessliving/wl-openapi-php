...
Only standard 4xx codes are accepted.
     ...
     *   - string text_phone_sender: Phone number of the business, which is added as sender for 2-Way SMS feature.
...
`null` or an empty value if this business does not use this feature.
    ...
    {
        return $this->client->request('/Wl/Sms/Phone/BusinessPhone.json', $this->params(), 'GET');
    }
