...
Only standard 4xx codes are accepted.
     ...
     *   - string k_spa_application: Key of the created or updated application.
Set in the response after a successful `post()` call.
    ...
    {
        return $this->client->request('/Wl/Skin/Application/Connect/ApplicationConnect.json', $this->params(), 'POST');
    }
