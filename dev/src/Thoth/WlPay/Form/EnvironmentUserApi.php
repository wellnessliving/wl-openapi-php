...
class EnvironmentUserApi
{
     ...
     *
     * @return EnvironmentUserApiGetResponse
     * @throws \WlSdk\WlSdkException On non-2xx HTTP response.
     * @throws \RuntimeException On network or cURL error.
     */
    public function get(): EnvironmentUserApiGetResponse
    {
        return new EnvironmentUserApiGetResponse($this->client->request('/Thoth/WlPay/Form/EnvironmentUser.json', $this->params(), 'GET'));
    }
